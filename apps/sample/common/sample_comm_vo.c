...
TS_S32 SAMPLE_COMM_VO_StartDev(VO_DEV VoDev, VO_PUB_ATTR_S* pstPubAttr)
{
    ...
    s32Ret = TS_MPI_VO_SetPubAttr(VoDev, pstPubAttr);
...
TS_S32 SAMPLE_COMM_VO_StopDev(VO_DEV VoDev)
{
    ...
    s32Ret = TS_MPI_VO_Disable(VoDev);
    if (s32Ret != TS_SUCCESS)
    {
        SAMPLE_PRT("failed with %#x!\n", s32Ret);
        return TS_FAILURE;
...
TS_S32 SAMPLE_COMM_VO_StartLayer(VO_LAYER VoLayer, const VO_VIDEO_LAYER_ATTR_S* pstLayerAttr)
{
    ...
    s32Ret = TS_MPI_VO_SetVideoLayerAttr(VoLayer, pstLayerAttr);
    if (s32Ret != TS_SUCCESS)
    {
        SAMPLE_PRT("failed with %#x!\n", s32Ret);
        return TS_FAILURE;
...
TS_S32 SAMPLE_COMM_VO_StopLayer(VO_LAYER VoLayer)
{
    ...
    s32Ret = TS_MPI_VO_DisableVideoLayer(VoLayer);
    if (s32Ret != TS_SUCCESS)
    {
        SAMPLE_PRT("failed with %#x!\n", s32Ret);
        return TS_FAILURE;
...
TS_S32 SAMPLE_COMM_VO_StartChn(VO_LAYER VoLayer, SAMPLE_VO_MODE_E enMode)
{
    ...
    s32Ret = TS_MPI_VO_GetVideoLayerAttr(VoLayer, &stLayerAttr);
    if (s32Ret != TS_SUCCESS)
    {
        SAMPLE_PRT("failed with %#x!\n", s32Ret);
        return TS_FAILURE;
    ...
    for (i = 0; i < u32WndNum; i++)
    {
        ...
        s32Ret = TS_MPI_VO_SetChnAttr(VoLayer, i, &stChnAttr);
        if (s32Ret != TS_SUCCESS)
        {
        ...
        s32Ret = TS_MPI_VO_EnableChn(VoLayer, i);
        if (s32Ret != TS_SUCCESS)
        {
            SAMPLE_PRT("failed with %#x!\n", s32Ret);
            return TS_FAILURE;
...
TS_S32 SAMPLE_COMM_VO_StopChn(VO_LAYER VoLayer, SAMPLE_VO_MODE_E enMode)
{
    ...
    for (i = 0; i < u32WndNum; i++)
    {
        s32Ret = TS_MPI_VO_DisableChn(VoLayer, i);
        if (s32Ret != TS_SUCCESS)
        {
            SAMPLE_PRT("failed with %#x!\n", s32Ret);
            return TS_FAILURE;
...
TS_VOID SAMPLE_COMM_VO_HdmiConvertSync(VO_INTF_SYNC_E enIntfSync,
    TS_HDMI_VIDEO_FMT_E *penVideoFmt)
{
    switch (enIntfSync)
    {
        case VO_OUTPUT_PAL:
            *penVideoFmt = TS_HDMI_VIDEO_FMT_PAL;
            break;
        case VO_OUTPUT_NTSC:
            *penVideoFmt = TS_HDMI_VIDEO_FMT_NTSC;
            break;
        case VO_OUTPUT_1080P24:
            *penVideoFmt = TS_HDMI_VIDEO_FMT_1080P_24;
            break;
        case VO_OUTPUT_1080P25:
            *penVideoFmt = TS_HDMI_VIDEO_FMT_1080P_25;
            break;
        case VO_OUTPUT_1080P30:
            *penVideoFmt = TS_HDMI_VIDEO_FMT_1080P_30;
            break;
        case VO_OUTPUT_720P50:
            *penVideoFmt = TS_HDMI_VIDEO_FMT_720P_50;
            break;
        case VO_OUTPUT_720P60:
            *penVideoFmt = TS_HDMI_VIDEO_FMT_720P_60;
            break;
        case VO_OUTPUT_1080I50:
            *penVideoFmt = TS_HDMI_VIDEO_FMT_1080i_50;
            break;
        case VO_OUTPUT_1080I60:
            *penVideoFmt = TS_HDMI_VIDEO_FMT_1080i_60;
            break;
        case VO_OUTPUT_1080P50:
            *penVideoFmt = TS_HDMI_VIDEO_FMT_1080P_50;
            break;
        case VO_OUTPUT_1080P60:
            *penVideoFmt = TS_HDMI_VIDEO_FMT_1080P_60;
            break;
        case VO_OUTPUT_576P50:
            *penVideoFmt = TS_HDMI_VIDEO_FMT_576P_50;
            break;
        case VO_OUTPUT_480P60:
            *penVideoFmt = TS_HDMI_VIDEO_FMT_480P_60;
            break;
        case VO_OUTPUT_800x600_60:
            *penVideoFmt = TS_HDMI_VIDEO_FMT_VESA_800X600_60;
            break;
        case VO_OUTPUT_1024x768_60:
            *penVideoFmt = TS_HDMI_VIDEO_FMT_VESA_1024X768_60;
            break;
        case VO_OUTPUT_1280x1024_60:
            *penVideoFmt = TS_HDMI_VIDEO_FMT_VESA_1280X1024_60;
            break;
        case VO_OUTPUT_1366x768_60:
            *penVideoFmt = TS_HDMI_VIDEO_FMT_VESA_1366X768_60;
            break;
        case VO_OUTPUT_1440x900_60:
            *penVideoFmt = TS_HDMI_VIDEO_FMT_VESA_1440X900_60;
            break;
        case VO_OUTPUT_1280x800_60:
            *penVideoFmt = TS_HDMI_VIDEO_FMT_VESA_1280X800_60;
            break;
        case VO_OUTPUT_1920x2160_30:
            *penVideoFmt = TS_HDMI_VIDEO_FMT_1920x2160_30;
            break;
        case VO_OUTPUT_1600x1200_60:
            *penVideoFmt = TS_HDMI_VIDEO_FMT_VESA_1600X1200_60;
            break;
        case VO_OUTPUT_1920x1200_60:
            *penVideoFmt = TS_HDMI_VIDEO_FMT_VESA_1920X1200_60;
            break;
        case VO_OUTPUT_2560x1440_30:
            *penVideoFmt = TS_HDMI_VIDEO_FMT_2560x1440_30;
            break;
        case VO_OUTPUT_2560x1600_60:
            *penVideoFmt = TS_HDMI_VIDEO_FMT_2560x1600_60;
            break;
        case VO_OUTPUT_3840x2160_30:
            *penVideoFmt = TS_HDMI_VIDEO_FMT_3840X2160P_30;
            break;
        case VO_OUTPUT_3840x2160_60:
            *penVideoFmt = TS_HDMI_VIDEO_FMT_3840X2160P_60;
        break;
        default:
            *penVideoFmt = TS_HDMI_VIDEO_FMT_1080P_60;
            break;
...
{
    TS_HDMI_ATTR_S      stAttr;
    TS_HDMI_VIDEO_FMT_E enVideoFmt;
    TS_HDMI_ID_E        enHdmiId    = TS_HDMI_ID_0;

    SAMPLE_COMM_VO_HdmiConvertSync(enIntfSync, &enVideoFmt);

    CHECK_RET(TS_MPI_HDMI_Init(), "TS_MPI_HDMI_Init");
    CHECK_RET(TS_MPI_HDMI_Open(enHdmiId), "TS_MPI_HDMI_Open");
    CHECK_RET(TS_MPI_HDMI_GetAttr(enHdmiId, &stAttr), "TS_MPI_HDMI_GetAttr");
    stAttr.bEnableHdmi           = TS_TRUE;
    stAttr.bEnableVideo          = TS_TRUE;
    stAttr.enVideoFmt            = enVideoFmt;
    stAttr.enVidOutMode          = TS_HDMI_VIDEO_MODE_YCBCR444;
    stAttr.enDeepColorMode       = TS_HDMI_DEEP_COLOR_24BIT;
    stAttr.bxvYCCMode            = TS_FALSE;
    stAttr.enOutCscQuantization  = HDMI_QUANTIZATION_LIMITED_RANGE;

    stAttr.bEnableAudio          = TS_FALSE;
    stAttr.enSoundIntf           = TS_HDMI_SND_INTERFACE_I2S;
    stAttr.bIsMultiChannel       = TS_FALSE;

    stAttr.enBitDepth            = TS_HDMI_BIT_DEPTH_16;

    stAttr.bEnableAviInfoFrame   = TS_TRUE;
    stAttr.bEnableAudInfoFrame   = TS_TRUE;
    stAttr.bEnableSpdInfoFrame   = TS_FALSE;
    stAttr.bEnableMpegInfoFrame  = TS_FALSE;

    stAttr.bDebugFlag            = TS_FALSE;
    stAttr.bHDCPEnable           = TS_FALSE;

    stAttr.b3DEnable             = TS_FALSE;
    stAttr.enDefaultMode         = TS_HDMI_FORCE_HDMI;

    CHECK_RET(TS_MPI_HDMI_SetAttr(enHdmiId, &stAttr), "TS_MPI_HDMI_SetAttr");
    CHECK_RET(TS_MPI_HDMI_Start(enHdmiId), "TS_MPI_HDMI_Start");
...
TS_S32 SAMPLE_COMM_VO_HdmiStartByDyRg(VO_INTF_SYNC_E enIntfSync, DYNAMIC_RANGE_E enDyRg)
{
    ...
    switch(enDyRg)
    {
        ...
        case DYNAMIC_RANGE_HDR10:
            stAttr.enVidOutMode    = TS_HDMI_VIDEO_MODE_YCBCR422;
            break;
        default:
            stAttr.enDeepColorMode = TS_HDMI_DEEP_COLOR_24BIT;
            break;
...
TS_S32 SAMPLE_COMM_VO_HdmiStop(TS_VOID)
{
    TS_HDMI_ID_E enHdmiId = TS_HDMI_ID_0;

    TS_MPI_HDMI_Stop(enHdmiId);
    TS_MPI_HDMI_Close(enHdmiId);
    TS_MPI_HDMI_DeInit();
...
VO_PUB_ATTR_S PUB_ATTR_1080P = {
	enIntfSync:VO_OUTPUT_1080I60,
	format:VO_FORMAT_NV12,
};

VO_PUB_ATTR_S PUB_ATTR_3840x2160 = {
	enIntfSync:VO_OUTPUT_3840x2160_30,
	format:VO_FORMAT_NV12,
};

TS_S32 SAMPLE_COMM_VO_GetPubAttr(SAMPLE_SNS_TYPE_E enSnsType, VO_PUB_ATTR_S *pstViDevAttr)
{
    switch (enSnsType)
    {
        case EVB_SENSOR:
        case EVB_SENSOR_2MP:
            memcpy(pstViDevAttr, &PUB_ATTR_1080P, sizeof(VO_PUB_ATTR_S));
            break;
        case EVB_SENSOR_4K:
            memcpy(pstViDevAttr, &PUB_ATTR_3840x2160, sizeof(VO_PUB_ATTR_S));
            break;
...
TS_S32 SAMPLE_COMM_VO_GetDefConfig(SAMPLE_VO_CONFIG_S *pstVoConfig)
{
	...
	if (SENSOR0_TYPE == EVB_SENSOR || SENSOR0_TYPE == EVB_SENSOR_2MP)
		pstVoConfig->enPixFormat       = PIXEL_FORMAT_NV_12;
...
TS_S32 SAMPLE_COMM_VO_StartVO(SAMPLE_VO_CONFIG_S *pstVoConfig)
{
    ...
    ********************************************/
    ...
    VO_INTF_TYPE_E         enVoIntfType   = VO_INTF_LCD;
    ...
    ********************************/
    ...
    stLayerAttr.bClusterMode     = TS_FALSE;
    stLayerAttr.bDoubleFrame    = TS_FALSE;
    ...
    ********************************/
    ...
    {
        s32Ret = TS_MPI_VO_SetDisplayBufLen(VoLayer, pstVoConfig->u32DisBufLen);
        if (TS_SUCCESS != s32Ret)
        {
            SAMPLE_PRT("TS_MPI_VO_SetDisplayBufLen failed with %#x!\n",s32Ret);
            SAMPLE_COMM_VO_StopDev(VoDev);
            return s32Ret;
        }
    }
    ...
    {
        s32Ret = TS_MPI_VO_GetVideoLayerCSC(VoLayer, &stVideoCSC);
        if (TS_SUCCESS != s32Ret)
        {
            SAMPLE_PRT("TS_MPI_VO_GetVideoLayerCSC failed!\n");
            SAMPLE_COMM_VO_StopDev(VoDev);
            return s32Ret;
        }
        stVideoCSC.enCscMatrix =VO_CSC_MATRIX_BT709_TO_RGB_PC;
        s32Ret = TS_MPI_VO_SetVideoLayerCSC(VoLayer, &stVideoCSC);
        if (TS_SUCCESS != s32Ret)
        {
            SAMPLE_PRT("TS_MPI_VO_SetVideoLayerCSC failed!\n");
            SAMPLE_COMM_VO_StopDev(VoDev);
            return s32Ret;
        }
    }
...
TS_S32 SAMPLE_COMM_VO_StartLayerChn(SAMPLE_COMM_VO_LAYER_CONFIG_S * pstVoLayerConfig)
{
    ...
    TS_S32                  s32Ret            = TS_SUCCESS;
    VO_VIDEO_LAYER_ATTR_S   stLayerAttr;
    TS_U32                  u32Frmt, u32Width, u32Height;
    ...
    ********************************/
    ...
    {
        s32Ret = TS_MPI_VO_SetDisplayBufLen(VoLayer, pstVoLayerConfig->u32DisBufLen);
        if (TS_SUCCESS != s32Ret)
        {
            SAMPLE_PRT("TS_MPI_VO_SetDisplayBufLen failed with %#x!\n",s32Ret);
            return s32Ret;
...
TS_VOID SAMPLE_COMM_VO_Exit(void)
{
    ...
    for (i=0; i < VO_MAX_LAYER_NUM; i++)
    {
        ...
        {
            TS_MPI_VO_DisableChn(i, j);
        }
    }

    for (i = 0; i < VO_MAX_LAYER_NUM; i++)
    {
        TS_MPI_VO_DisableVideoLayer(i);
    }
...
*/
static TS_VOID SAMPLE_PRIVATE_VO_InitScreen1080x1920(TS_S32 fd)
{
    TS_S32 s32Ret;
    cmd_info_t cmd_info;
    ...
    cmd_info.cmd = NULL;
    s32Ret = ioctl(fd, TS_MIPI_TX_SET_CMD, &cmd_info);
    if (TS_SUCCESS != s32Ret)
    {
...
*/
static TS_VOID SAMPLE_PRIVATE_VO_InitScreen720x1280(TS_S32 s32fd)
{
    TS_S32     fd     = s32fd;
    TS_S32     s32Ret;
    TS_U8      cmd[30];
...
*/
static void SAMPLE_PRIVATE_VO_InitMipiTxScreen(VO_INTF_SYNC_E enVoIntfSync, TS_S32 fd)
{
...
void SAMPLE_COMM_VO_StartMipiTx(VO_INTF_SYNC_E enVoIntfSync)
{
    ...
    fd = open("/dev/ts_mipi_tx", O_RDWR);
    if (fd < 0)
    {
        SAMPLE_PRT("open ts_mipi_tx dev failed\n");
        return;
    }
    ...
    */
    s32Ret = ioctl(fd, TS_MIPI_TX_SET_DEV_CFG, pstMipiTxConfig);
    if (TS_SUCCESS != s32Ret)
    {
    ...
    */
    s32Ret = ioctl(fd, TS_MIPI_TX_ENABLE);
    if (TS_SUCCESS != s32Ret)
    {
...
/*
* Name:     SAMPLE_COMM_VO_SetSceenParam
* Desc:     screen param setting for dt53, support mipi and rgb.
* Input:    screen_type
* Output:   TS_SUCCESS
*/
...
{
    TS_S32  s32Ret = TS_SUCCESS;
    VO_PUB_ATTR_S voDevAttr = {0};  
    memset(&voDevAttr, 0x00, sizeof(VO_PUB_ATTR_S));
    s32Ret = TS_MPI_VO_GetPubAttr(SAMPLE_VO_DEV_UHD, &voDevAttr);
    if (TS_SUCCESS != s32Ret)
    {
        SAMPLE_PRT("vo dev get pub failed. s32Ret: 0x%x !\n", s32Ret);
        return TS_FAILURE;
    }

    if(VO_SCREEN_TYPE_MIPI == screen_type )
    {
        SAMPLE_PRT("find VO_SCREEN_TYPE_MIPI, mipi screen param setting ...\n");  

        voDevAttr.enIntfType = VO_INTF_LCD;
        voDevAttr.enIntfSync = VO_OUTPUT_1080x1920_60;
    
        // mipi stSyncInfo 屏参设置
        voDevAttr.stSyncInfo.bSynm = 0;
        voDevAttr.stSyncInfo.bIop = 0;
        voDevAttr.stSyncInfo.u8Intfb = 0;
     
        voDevAttr.stSyncInfo.pixelclock = 143762400;
        voDevAttr.stSyncInfo.u16Hact = 1080;
        voDevAttr.stSyncInfo.u16Hbb = 262;
        voDevAttr.stSyncInfo.u16Hfb = 80;
        voDevAttr.stSyncInfo.u16Hpw = 10;
    
        voDevAttr.stSyncInfo.u16Vact = 1920;
        voDevAttr.stSyncInfo.u16Vbb = 8;
        voDevAttr.stSyncInfo.u16Vfb = 15;
        voDevAttr.stSyncInfo.u16Vpw = 5;
        s32Ret = TS_MPI_VO_SetPubAttr(SAMPLE_VO_DEV_UHD, &voDevAttr);
        if (TS_SUCCESS != s32Ret)
        {         
            SAMPLE_PRT("TS_MPI_VO_SetPubAttr failed, s32Ret: 0x%x !\n", s32Ret);  
            return TS_FAILURE;
        }
    }
    else if(VO_SCREEN_TYPE_RGB == screen_type )
    {
        SAMPLE_PRT("find VO_SCREEN_TYPE_RGB, reg iomux config ...\n");
        voDevAttr.enIntfType = VO_INTF_LCD;
        voDevAttr.enIntfSync = VO_OUTPUT_1080x1920_60;
        
        voDevAttr.stSyncInfo.u16Hact = 240;
        voDevAttr.stSyncInfo.u16Vact = 320;
        s32Ret = TS_MPI_VO_SetPubAttr(SAMPLE_VO_DEV_UHD, &voDevAttr);
        if (TS_SUCCESS != s32Ret)
        {         
            SAMPLE_PRT("TS_MPI_VO_SetPubAttr failed, s32Ret: 0x%x !\n", s32Ret);  
    ...
    else if(VO_SCREEN_TYPE_SPI == screen_type )
    {
        SAMPLE_PRT("VO_SCREEN_TYPE_SPI is not support!\n"); 
        return TS_FAILURE;
    }
    else
    {
        SAMPLE_PRT("unknow screen_type:%d!\n", screen_type); 
        return TS_FAILURE;
    }
...
#if defined(TX5336)
static TS_U32 extract_value(const char *output) 
{
    TS_U32 value;
    sscanf(output, "0x%x", &value);
    return value;
}
...
TS_S32 SAMPLE_COMM_VO_LCD_IOMUX(void)
{
    char command[128];
    char *output;
    unsigned int original_value, new_value;
	int fd;

	fd = open("/dev/panel_dev", O_RDWR);
    if(fd >= 0) 
    {
        // mipi lcd pwm6 iomux， reg 0xf038962c bit3~bit0 is 0x03, other bit is not changed
        snprintf(command, sizeof(command), "devmem 0xf038962c 32");
        output = SAMPLE_COMM_EXECUTE_CMD_BY_POPEN(command);
        if (output == TS_NULL) {
            SAMPLE_PRT("devmem 0xf038962c 32 read failed!\n");
            return TS_FAILURE;
        }
        original_value = extract_value(output);
        SAMPLE_PRT("devmem 0xf038962c original_value: 0x%08x\n", original_value); 

        // clear bit3 - bit0 
        unsigned int clear_mask = ~0x0F;
        unsigned int cleared_value = original_value & clear_mask;

        // write the value
        unsigned int write_value = 3;
        unsigned int shifted_value = write_value & 0x0F;

        new_value = cleared_value | shifted_value;
        // SAMPLE_PRT("devmem 0xf038962c new_value: 0x%08x\n", new_value);

        snprintf(command, sizeof(command), "devmem 0xf038962c 32 0x%08x", new_value);
        SAMPLE_COMM_EXECUTE_CMD_BY_SYSTEM(command);       
    }
    else
    {
        // 1. reg 0xf038932c bit15~bit0不变， 改为0x4444****
        snprintf(command, sizeof(command), "devmem 0xf038932c 32");
        output = SAMPLE_COMM_EXECUTE_CMD_BY_POPEN(command);
        if (output == TS_NULL) {
            SAMPLE_PRT("devmem 0xf038932c 32 read failed!\n");
            return TS_FAILURE;
        }
        original_value = extract_value(output);
        new_value = (0x4444 << 16) | (original_value & 0xFFFF);
        // SAMPLE_PRT("devmem 0xf038932c new_value: 0x%08x\n", new_value);
        snprintf(command, sizeof(command), "devmem 0xf038932c 32 0x%08x", new_value);
        SAMPLE_COMM_EXECUTE_CMD_BY_SYSTEM(command);

        // 2. reg 0xf038942c bit31~bit24不变， 改为0x**444444
        snprintf(command, sizeof(command), "devmem 0xf038942c 32");
        output = SAMPLE_COMM_EXECUTE_CMD_BY_POPEN(command);
        if (output == TS_NULL) {
            SAMPLE_PRT("devmem 0xf038942c 32 read failed!\n");
            return TS_FAILURE;
        }
        original_value = extract_value(output);
        new_value = ((original_value << 24) & 0xFF) | 0x444444;
        // SAMPLE_PRT("devmem 0xf038942c new_value: 0x%08x\n", new_value);
        snprintf(command, sizeof(command), "devmem 0xf038942c 32 0x%08x", new_value);
        SAMPLE_COMM_EXECUTE_CMD_BY_SYSTEM(command);

        // 3. reg 0xf038952c bit31~bit24不变， 改为0x**444444
        snprintf(command, sizeof(command), "devmem 0xf038952c 32");
        output = SAMPLE_COMM_EXECUTE_CMD_BY_POPEN(command);
        if (output == TS_NULL) {
            SAMPLE_PRT("devmem 0xf038952c 32 read failed!\n");
            return TS_FAILURE;
        }
        original_value = extract_value(output);
        new_value = ((original_value << 24) & 0xFF) | 0x444444;
        // SAMPLE_PRT("devmem 0xf038952c new_value: 0x%08x\n", new_value);
        snprintf(command, sizeof(command), "devmem 0xf038952c 32 0x%08x", new_value);
        SAMPLE_COMM_EXECUTE_CMD_BY_SYSTEM(command);

        // 4. reg 0xf038962c bit7~bit0不变， 改为0x444444**
        snprintf(command, sizeof(command), "devmem 0xf038962c 32");
        output = SAMPLE_COMM_EXECUTE_CMD_BY_POPEN(command);
        if (output == TS_NULL) {
            SAMPLE_PRT("devmem 0xf038962c 32 read failed!\n");
        ...
        original_value = extract_value(output);
        new_value = (0x444444 << 8) | (original_value & 0xFF);
        // SAMPLE_PRT("devmem 0xf038962c new_value: 0x%08x\n", new_value);
        snprintf(command, sizeof(command), "devmem 0xf038962c 32 0x%08x", new_value);
        SAMPLE_COMM_EXECUTE_CMD_BY_SYSTEM(command);        
        
        SAMPLE_COMM_EXECUTE_CMD_BY_SYSTEM("devmem 0xf0389348 32 0");
        SAMPLE_COMM_EXECUTE_CMD_BY_SYSTEM("devmem 0xf0389448 32 0");
        SAMPLE_COMM_EXECUTE_CMD_BY_SYSTEM("devmem 0xf0389548 32 0");
        SAMPLE_COMM_EXECUTE_CMD_BY_SYSTEM("devmem 0xf0389648 32 0");

        SAMPLE_PRT("SAMPLE_VO_RGBLCD_IOMUX successful!\n");
    }
