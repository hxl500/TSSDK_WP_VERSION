 ...
 * Create: 2022/08/24
 */
#ifndef _TS_ALG_BODY_DETECT_V2_H_
#define _TS_ALG_BODY_DETECT_V2_H_
 ...
 * @return error code
 */
TS_S32 TS_ALG_BodyDetect_Process(TS_VOID *pHandle, ALG_IMAGE_S *pImage, ALG_CatDetect_DET_RESULT_S *pResult);
 ...
 */
TS_S32 TS_ALG_BodyDetect_SetParam(TS_VOID *pHandle, ALG_BODYDET_PARAM_S *pParam);
 ...
 * @return 0 or error code
 */
TS_S32 TS_ALG_BodyDetect_GetParam(TS_VOID *pHandle, ALG_BODYDET_PARAM_S *pParam);
 ...
 * @return version
 */
const TS_CHAR* TS_ALG_BodyDetect_GetVersion();
/**
lx test
*/
int test_conf_get();
