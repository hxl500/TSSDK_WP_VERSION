 ...
 * Description: ts_mipi.h
 * Author:TsingMicro multimedia software group
 * Create: 2022/06/02
 */

#ifndef __TS_MIPI_RX_H__
#define __TS_MIPI_RX_H__
...
typedef enum
{
    TS_MIPI_WDR_MODE_NONE = 0x0,
    TS_MIPI_WDR_MODE_VC   = 0x1,    /* Virtual Channel */
    TS_MIPI_WDR_MODE_DT   = 0x2,    /* Data Type */
    TS_MIPI_WDR_MODE_DOL  = 0x3,    /* DOL Mode */
    TS_MIPI_WDR_MODE_BUTT
} mipi_wdr_mode_t;
...
typedef struct
{
    ...
    union
    {
        short data_type[WDR_VC_NUM];                /* used by the TS_MIPI_WDR_MODE_DT */
    };
} mipi_dev_attr_t;

typedef enum
{
    TS_WDR_MODE_NONE    = 0x0,
    TS_WDR_MODE_2F      = 0x1,
    TS_WDR_MODE_3F      = 0x2,
    TS_WDR_MODE_4F      = 0x3,
    TS_WDR_MODE_DOL_2F  = 0x4,
    TS_WDR_MODE_DOL_3F  = 0x5,
    TS_WDR_MODE_DOL_4F  = 0x6,
    TS_WDR_MODE_BUTT
} wdr_mode_t;
...
#define TS_MIPI_IOC_MAGIC   'm'

/* init data lane, input mode, data type */
#define TS_MIPI_SET_DEV_ATTR                _IOW(TS_MIPI_IOC_MAGIC, 0x01, combo_dev_attr_t)

/* set phy common mode voltage mode */
#define TS_MIPI_SET_PHY_CMVMODE             _IOW(TS_MIPI_IOC_MAGIC, 0x04, phy_cmv_t)

/* reset sensor */
#define TS_MIPI_RESET_SENSOR                _IOW(TS_MIPI_IOC_MAGIC, 0x05, sns_rst_source_t)

/* unreset sensor */
#define TS_MIPI_UNRESET_SENSOR              _IOW(TS_MIPI_IOC_MAGIC, 0x06, sns_rst_source_t)

/* reset mipi */
#define TS_MIPI_RESET_MIPI                  _IOW(TS_MIPI_IOC_MAGIC, 0x07, combo_dev_t)

/* unreset mipi */
#define TS_MIPI_UNRESET_MIPI                _IOW(TS_MIPI_IOC_MAGIC, 0x08, combo_dev_t)

/* reset slvs */
#define TS_MIPI_RESET_SLVS                  _IOW(TS_MIPI_IOC_MAGIC, 0x09, combo_dev_t)

/* unreset slvs */
#define TS_MIPI_UNRESET_SLVS                _IOW(TS_MIPI_IOC_MAGIC, 0x0a, combo_dev_t)

/* set mipi hs_mode*/
#define TS_MIPI_SET_HS_MODE                 _IOW(TS_MIPI_IOC_MAGIC, 0x0b, lane_divide_mode_t)

/* enable mipi clock*/
#define TS_MIPI_ENABLE_MIPI_CLOCK           _IOW(TS_MIPI_IOC_MAGIC, 0x0c, combo_dev_t)

/* disable mipi clock*/
#define TS_MIPI_DISABLE_MIPI_CLOCK          _IOW(TS_MIPI_IOC_MAGIC, 0x0d, combo_dev_t)

/* enable slvs clock*/
#define TS_MIPI_ENABLE_SLVS_CLOCK           _IOW(TS_MIPI_IOC_MAGIC, 0x0e, combo_dev_t)

/* disable slvs clock*/
#define TS_MIPI_DISABLE_SLVS_CLOCK          _IOW(TS_MIPI_IOC_MAGIC, 0x0f, combo_dev_t)

/* enable sensor clock */
#define TS_MIPI_ENABLE_SENSOR_CLOCK         _IOW(TS_MIPI_IOC_MAGIC, 0x10, sns_clk_source_t)

/* disable sensor clock */
#define TS_MIPI_DISABLE_SENSOR_CLOCK        _IOW(TS_MIPI_IOC_MAGIC, 0x11, sns_clk_source_t)

#endif /* __TS_MIPI_RX_H__ */
