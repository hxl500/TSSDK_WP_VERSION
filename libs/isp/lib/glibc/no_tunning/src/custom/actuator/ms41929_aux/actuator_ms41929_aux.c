...
#include "actuator_ms41929_aux.h"
...
{
    {.type = DRV_POWER_REG, .regAddr = 0x83c40044, .bitMask  = 0x02, .bitVal = 0x00, .delayUs = 20000}, /// 20ms
    {.type = DRV_POWER_REG, .regAddr = 0x83c40044, .bitMask  = 0x02, .bitVal = 0x01, .delayUs = 20000}, /// SENSOR1_CTRL_REG 0x83c40044
    {.type = DRV_POWER_REG, .regAddr = 0x83c40044, .bitMask  = 0x04, .bitVal = 0x00, .delayUs = 10000}, /// SENSOR1_CTRL_REG 0x83c40044
};


static drv_power_setting_t ms41929_power_down_setting[] =
{
    {.type = DRV_POWER_REG, .regAddr = 0x83c40044, .bitMask  = 0x02, .bitVal = 0x00, .delayUs = 20000},
};

static drv_power_setting_t ms41929_plus_powerCfg[] =
{
    {.type = DRV_POWER_REG, .regAddr = 0x83c40044, .bitMask  = 0x04, .bitVal = 0x01, .delayUs = 1400}, /// pulse duration 1.4ms
    {.type = DRV_POWER_REG, .regAddr = 0x83c40044, .bitMask  = 0x04, .bitVal = 0x00, .delayUs = 0}
};
...
static actuator_drv_params_t ms41929_actuator_params_aux =
{
...
actuator_drv_params_t * Load_Ms41929_Aux_Actuator_Driver(void)
{
    return &ms41929_actuator_params_aux;
}
