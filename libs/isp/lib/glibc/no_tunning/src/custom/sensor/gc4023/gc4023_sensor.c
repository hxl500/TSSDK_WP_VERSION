...
static isp_ret_t GC4023_Normal_Fill_Exposure_Reg(sensor_apply_exp_param_t *pExpParam, drv_regs_array_info_t *pRegInfo)
{
...
isp_ret_t GC4023_Fill_Exposure_Reg(sensor_apply_exp_param_t *pExpParam, drv_regs_array_info_t *pRegInfo)
{
    ...
    if (ret == ISP_RET_SUCCESS)
    {
        ...
        {
            ret = GC4023_Normal_Fill_Exposure_Reg(pExpParam, pRegInfo);
        }
        else
        {
