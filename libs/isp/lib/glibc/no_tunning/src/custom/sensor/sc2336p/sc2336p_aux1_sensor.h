...
#ifndef __SC2336P_SENSOR_H__
#define __SC2336P_SENSOR_H__
...
//SC2336P All-pixel scan CSI-2_2lane 24Mhz AD:10bit Output:10bit 396Mbps Master Mode 15.00fps Integration Time: Xx.xxms Gain:XdB vts = 1125 row time=22.22us
static drv_sensor_reg_info_t  sc2336p_1080p_setting[] =
{
    ...
    { .regAddr=0x320e, .regData=0x09, .delayUs=0 },
    { .regAddr=0x320f, .regData=0x60, .delayUs=0 },
	{ .regAddr=0x3211, .regData=0x03, .delayUs=0 },
	{ .regAddr=0x3213, .regData=0x03, .delayUs=0 },
	{ .regAddr=0x3221, .regData=0xff, .delayUs=0 },
...
//    { .regAddr=0x4501, .regData=0xcc, .delayUs=0 }, //test pattern
...
static drv_sensor_reg_info_t  sc2336p_streamOn_setting[] =
{
	{ .regAddr=0x0100, .regData= 0x01, .delayUs=0 },
};

static drv_sensor_reg_info_t  sc2336p_streamOff_setting[] =
{
	{ .regAddr=0x0100, .regData= 0x00, .delayUs=500000 }, //500ms
};

static drv_sensor_exp_param_t sc2336p_30fps_exparams =
{
    .maxIntegrationTime = 2394,
...
static drv_sensor_exp_param_t sc2336p_20fps_exparams =
{
    .maxIntegrationTime = 2394,
    .minIntegrationTime = 1,
...
static drv_sensor_exp_param_t sc2336p_15fps_exparams =
{
    .maxIntegrationTime = 2394,
    .minIntegrationTime = 1,
    .maxAnalogGain      = 128*1024,
...
static drv_power_setting_t sc2336p_power_up_setting[] =
{
...
static drv_power_setting_t sc2336p_power_down_setting[] =
{
...
static sensor_drv_params_t sc2336p_aux1_sensor_params =
{
    .sensorId     = 0x3a,//0xcb,
    ...
    .powerUpSettings  =
    {
        .powerSetting = sc2336p_power_up_setting,
        .size = sizeof(sc2336p_power_up_setting) / sizeof(sc2336p_power_up_setting[0]),
    },
    .powerDownSettings =
    {
        .powerSetting  = sc2336p_power_down_setting,
        .size = sizeof(sc2336p_power_down_setting) / sizeof(sc2336p_power_down_setting[0]),
    },
    .activesize =
    {
        .width  = 1920,
	...
	.modeSettings[0] =
	{
		...
		.regConfig =
		{
			...
			.regAddrType = DRV_ADDR_TYPE_WORD,
			.direction   = DRV_DIRECTION_WRITE,
			.settings    = sc2336p_1080p_setting,
			.settingSize = sizeof(sc2336p_1080p_setting) / sizeof (sc2336p_1080p_setting[0]),
		},
		.expParams   = &sc2336p_15fps_exparams,
    ...
    .streamOnSetting =
    {
        ...
        .regAddrType = DRV_ADDR_TYPE_WORD,
        .direction   = DRV_DIRECTION_WRITE,
        .settings    = sc2336p_streamOn_setting,
        .settingSize = sizeof(sc2336p_streamOn_setting) / sizeof (sc2336p_streamOn_setting[0]),
    },
    ...
    .streamOffSetting =
    {
        ...
        .regAddrType = DRV_ADDR_TYPE_WORD,
        .direction   = DRV_DIRECTION_WRITE,
        .settings    = sc2336p_streamOff_setting,
        .settingSize = sizeof(sc2336p_streamOff_setting) / sizeof (sc2336p_streamOff_setting[0]),
    },

    .fill_exposure_reg = SC2336P_Fill_Exposure_Reg,
};
