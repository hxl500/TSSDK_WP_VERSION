...
#ifndef __C3390_AUX1_SENSOR_H__
#define __C3390_AUX1_SENSOR_H__

#include "sensor_common.h"
#include "log_utils.h"

isp_ret_t c3390_Fill_Exposure_Reg(sensor_apply_exp_param_t * pExpParam, drv_regs_array_info_t * pRegInfo);
//C3390 All-pixel scan CSI-2_2lane 27Mhz AD:10bit Output:10bit 704Mbps Master Mode 30.00fps Integration Time: Xx.xxms Gain:XdB vts = 1500 row time=22.22us
...
{	
	...
	{ .regAddr=0x0101, .regData= 0x01, .delayUs=0 },
...
static sensor_drv_params_t c3390_aux1_sensor_params =
{
    .sensorId     = 0x01,
    .sensorIdAddr = 0x0001,
    .name         = "c3390",
