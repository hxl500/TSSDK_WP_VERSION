...
static tune_params_t g_tuningParams =
{
    ...
    #include "tuning_ar0239_normal_oct.h"
#else
    #include "tuning_ar0239_normal_tit.h"
#endif
};
...
static void Load_Ar0239_Normal_Tuning_JSON(const char8 *filename)
{
...
*
*/
tune_params_t* Load_Ar0239_Normal_Tuning(const char8 *filename)
{
    FW_FUNC_ENTER();

    if (!g_isJsonLoaded)
    {
        Load_Ar0239_Normal_Tuning_JSON(filename);
    }
