...
typedef struct
{
    ...
    u32  sdeRatioU;       /// sde staturation ratio for u, default 1024, [0,4096]
    u32  sdeRatioV;

} sde_core_param_by_gain_t;
typedef struct
{
    u32  sdeBrightness;   /// default 1024, [0:4096]
...
typedef struct
{
	...
	DYNAMIC_TABLE(sde_core_param_by_lux_sat_t, sdeLuxBrightnessTab);
} tune_sde_param_t;
