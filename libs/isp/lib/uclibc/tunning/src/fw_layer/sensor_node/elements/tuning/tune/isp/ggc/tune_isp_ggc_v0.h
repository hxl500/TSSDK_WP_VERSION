...
typedef struct
{
    ...
    u32 ggcLocalLumAdjNode2;        /// default 50, [0:100], Lum adjust in node 2
    u32 ggcLocalLumAdjNode3;        /// default 50, [0:100], Lum adjust in node 3
    u32 ggcLocalLumAdjNode4;        /// default 50, [0:100], Lum adjust in node 4
    ...
    u32 ggcGlobalLuminationAdj;    /// default 128, [0:256], Global lumination adjust
