...
static drv_sensor_reg_info_t  cv2003_2mp_setting[] =
{
	...
	{ .regAddr=0x3020, .regData= 0xC4, .delayUs=0 },   //C4   88
	{ .regAddr=0x3021, .regData= 0x09, .delayUs=0 },//09    13
...
{
    .maxIntegrationTime =16608,//framth=2n，5000=2500*2-12
    .minIntegrationTime = 2,
    .maxAnalogGain      = 133444, //266300, //65536,//133300,
    .minAnalogGain      = 1024,
    .lineTime           = 49325,
