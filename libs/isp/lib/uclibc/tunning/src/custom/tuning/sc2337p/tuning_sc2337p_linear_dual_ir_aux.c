...
{
#ifndef LENS_2P8MM
  #include "tuning_sc2337p_linear_dual_ir_aux.h"
#else
  #include "tuning_sc2337p_linear_dual_ir_2p8mm.h"
#endif
};
...
tune_params_t *load_sc2337p_normal_ir_aux_tuning(const char8 *filename)
{
  FW_FUNC_ENTER();
