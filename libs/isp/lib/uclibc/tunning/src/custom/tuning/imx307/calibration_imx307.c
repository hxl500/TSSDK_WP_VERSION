...
{
    #include "calibration_imx307.h"
};

static BOOL g_isJsonLoaded = FALSE;

/// Load offline json setting
static void Load_Imx307_Calibration_JSON(const char8* filename)
{
...
/*
* Load_Imx307_Calibration
*
* @brief Load calibration parameters of imx307 from static headers or json
*
...
*
*/
calibration_params_t* Load_Imx307_Calibration(const char8* filename)
{
    FW_FUNC_ENTER();

    if (!g_isJsonLoaded)
    {
        Load_Imx307_Calibration_JSON(filename);
    }
