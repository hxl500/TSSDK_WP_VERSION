...
static tune_params_t g_tuningParams =
{
    ...
    #include "tuning_imx415_dol2_ir.h"
    #else
...
static void load_imx415_dol2_tuning_json(const char8 *filename)
{
...
*
*/
tune_params_t* load_imx415_dol2_ir_tuning(const char8 *filename)
{
    FW_FUNC_ENTER();

    if (!g_isJsonLoaded)
    {
        load_imx415_dol2_tuning_json(filename);
    }
