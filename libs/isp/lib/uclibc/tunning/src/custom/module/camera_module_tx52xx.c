...
extern sensor_drv_params_t *load_sc2337p_sensor_driver(void);
extern sensor_drv_params_t* load_sc2337p_aux1_sensor_driver(void);
extern csi2d_drv_params_t *load_sc2337p_csi2d_driver(void);
extern csi2d_drv_params_t *load_sc2337p_aux1_csi2d_driver(void);
extern tune_params_t *load_sc2337p_normal_tuning(const char8 *);
extern tune_params_t *load_sc2337p_normal_tuning_aux(const char8 *);
extern calibration_params_t *load_sc2337p_calibration(const char8 *);
extern calibration_params_t *load_sc2337p_ir_calibration(const char8 *);
extern tune_params_t *load_sc2337p_normal_ir_tuning(const char8 *);
extern tune_params_t *load_sc2337p_normal_ir_aux_tuning(const char8 *);
...
static camera_module_params_t camera_module[CAMERA_NUM] = {
	[CAMERA_IDX0] = {
		...
		.params = {
			[CAMERA_SESSION_VISIBLE] = {
				.actuator = load_normal_actuator_driver,
				.sensor = load_sc2337p_sensor_driver,
				.csid = load_sc2337p_csi2d_driver,
				.tune = {
					[CAMERA_HDR_MODE_NORMAL] = {load_sc2337p_normal_tuning, "sc2337p_nor.tun"},
				},
				.calib = {load_sc2337p_calibration, "sc2337p.cal"},
			},
			...
			[CAMERA_SESSION_IR] = {
				...
				.calib = {load_sc2337p_ir_calibration, "sc2337p.cal"},
			},
			...
			[CAMERA_SESSION_WHITELIGHT] = {
				...
				.csid = load_sc2337p_csi2d_driver,
				.tune = {
					[CAMERA_HDR_MODE_NORMAL] = {load_sc2337p_normal_tuning_aux, "sc2337p_nor_wl.tun"},
				},
				.calib = {load_sc2337p_calibration, "sc2337p.cal"},
			},
		},
