...
//SC200ai All-pixel scan CSI-2_2lane 24Mhz AD:10bit Output:10bit 371.25Mbps Master Mode 30.00fps Integration Time: Xx.xxms Gain:XdB vts = 1125 row time=22.22us
...
static sensor_drv_params_t sc200ai_sensor_params =
{
    .sensorId     = 0xcb,
    .sensorIdAddr = 0x3107,
    .name         = "sc200ai",
