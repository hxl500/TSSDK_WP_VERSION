...
{	
 ...
 //blc
 	{ .regAddr=0x0170, .regData= 0x38, .delayUs=0 },
	{ .regAddr=0x0171, .regData= 0x38, .delayUs=0 },
	{ .regAddr=0x0172, .regData= 0x38, .delayUs=0 },
	{ .regAddr=0x0173, .regData= 0x38, .delayUs=0 },
};
...
{
    .maxIntegrationTime = 1800,
    .minIntegrationTime = 8,
    .maxAnalogGain      = 65536,//32536,
    .minAnalogGain      = 1024,
...
static sensor_drv_params_t gc2083_aux1_sensor_params =
{
    .sensorId     = 0x83,
    .sensorIdAddr = 0x3f1,
    .name         = "gc2083",
