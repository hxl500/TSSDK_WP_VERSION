 ...
 * Description: ts_math.h
 * Author:TsingMicro multimedia software group
 * Create: 2022/06/02
 */

#ifndef __TS_MATH_H__
#define __TS_MATH_H__
...
** SPAN(TS_U32, 100, 200) is 200 - 100 = 100
** SPAN(TS_U32, 200, 100) is 0xFFFFFFFF - 200 + 100
** SPAN(TS_U64, 200, 100) is 0xFFFFFFFFFFFFFFFF - 200 + 100
******************************************************************************/
...
__inline static TS_BOOL IS_LITTLE_END(void)
{
    union unEND_TEST_U
    {
        TS_CHAR cTest[4];
    ...
    return (unEndTest.u32Test > 0x01020304) ? (TS_TRUE) : (TS_FALSE);
}
...
******************************************************************************/
__inline static TS_VOID Rgb2Yc(TS_U16 r, TS_U16 g, TS_U16 b, TS_U16 * py, TS_U16 * pcb, TS_U16 * pcr)
{
    /* Y */
    *py = (TS_U16)((((r*66+g*129+b*25) >> 8) + 16) << 2);

    /* Cb */
    *pcb = (TS_U16)(((((b*112-r*38)-g*74) >> 8) + 128) << 2);

    /* Cr */
    *pcr = (TS_U16)(((((r*112-g*94)-b*18) >> 8) + 128) << 2);
}

__inline static TS_U32 Rgb2Yuv(TS_U32 u32Rgb)
{
    TS_U16 y,u,v;
...
__inline static TS_VOID Rgb2Yc_full(TS_U16 r, TS_U16 g, TS_U16 b, TS_U16 *py, TS_U16 *pcb, TS_U16 *pcr)
{
    TS_U16 py_temp, pcb_temp, pcr_temp;

    py_temp  = (TS_U16)(((r*76 + g*150 + b*29)>>8) * 4);
    pcb_temp = (TS_U16)(CLIP_MIN(((((b*130 - r*44 ) - g*86) >> 8)+128),0) * 4);
    pcr_temp = (TS_U16)(CLIP_MIN(((((r*130 - g*109) - b*21) >> 8)+128),0) * 4);
...
__inline static TS_U32 Rgb2Yuv_full(TS_U32 u32Rgb)
{
    TS_U16 y,u,v;
...
******************************************************************************/
__inline static TS_VOID Rgb2Yc_8BIT(TS_U8 r, TS_U8 g, TS_U8 b, TS_U8 *py, TS_U8 *pcb, TS_U8 *pcr)
{
    /* Y */
    *py = (TS_U8)(((r*66+g*129+b*25) >> 8) + 16);

    /* Cb */
    *pcb = (TS_U8)((((b*112-r*38)-g*74) >> 8) + 128);

    /* Cr */
    *pcr = (TS_U8)((((r*112-g*94)-b*18) >> 8) + 128);
}

__inline static TS_U32 Rgb2Yuv_8BIT(TS_U32 u32Rgb)
{
    TS_U8 y,u,v;
...
__inline static TS_VOID Rgb2Yc_full_8BIT(TS_U8 r, TS_U8 g, TS_U8 b, TS_U8 *py, TS_U8 *pcb, TS_U8 *pcr)
{
    TS_S16 py_temp, pcb_temp, pcr_temp;
...
__inline static TS_U32 Rgb2Yuv_full_8BIT(TS_U32 u32Rgb)
{
    TS_U8 y,u,v;
...
**
*******************************************************************************/
typedef struct tsFPS_CTRL_S
{
    TS_U32 u32Ffps;    /* Full frame rate    */
    TS_U32 u32Tfps;    /* Target frame rate  */
    TS_U32 u32FrmKey;  /* update key frame   */
} FPS_CTRL_S;

__inline static TS_VOID InitFps(FPS_CTRL_S *pFrmCtrl, TS_U32 u32FullFps,
                                TS_U32 u32TagFps)
{
...
__inline static TS_BOOL FpsControl(FPS_CTRL_S *pFrmCtrl)
{
    TS_BOOL   bReturn       = TS_FALSE;
...
__inline static TS_U32 GetLowAddr(TS_U64  u64Phyaddr)
{
    return (TS_U32)u64Phyaddr;
}


__inline static TS_U32 GetHighAddr(TS_U64  u64Phyaddr)
{
    return (TS_U32)(u64Phyaddr>>32);
}




#define ts_usleep(usec) \
do { \
    usleep(usec); \
} while (0)
