 ...
 * Description: ts_buffer.h
 * Author:TsingMicro multimedia software group
 * Create: 2022/06/02
 */
#ifndef __TS_BUFFER_H__
#define __TS_BUFFER_H__
...
#define TS_MAXINUM_LIMIT 100000

__inline static TS_VOID COMMON_GetPicBufferConfig(TS_U32 u32Width, TS_U32 u32Height,
    PIXEL_FORMAT_E enPixelFormat, DATA_BITWIDTH_E enBitWidth,
    COMPRESS_MODE_E enCmpMode, TS_U32 u32Align, VB_CAL_CONFIG_S *pstCalConfig)
{
    TS_U32 u32BitWidth = 0;
    TS_U32 u32HeadStride = 0;
    TS_U32 u32VBSize = 0;
    TS_U32 u32HeadSize = 0;
    TS_U32 u32AlignHeight;
    TS_U32 u32MainStride = 0;
    TS_U32 u32MainSize = 0;
    TS_U32 u32ExtStride = 0;
    TS_U32 u32ExtSize = 0;
    TS_U32 u32ExtYSize = 0;
    TS_U32 u32HeadYSize = 0;
    TS_U32 u32YSize = 0;

    if ((u32Width > TS_MAXINUM_LIMIT) || (u32Height > TS_MAXINUM_LIMIT)) {
...
__inline static TS_U32 COMMON_GetPicBufferSize(TS_U32 u32Width, TS_U32 u32Height,
                                               PIXEL_FORMAT_E enPixelFormat,
                                               DATA_BITWIDTH_E enBitWidth, COMPRESS_MODE_E enCmpMode, TS_U32 u32Align)
{
...
__inline static TS_U32 VI_GetRawBufferSizeEx(TS_U32 u32Width, TS_U32 u32Height,
                                             PIXEL_FORMAT_E enPixelFormat,
                                             COMPRESS_MODE_E enCmpMode, TS_U32 u32CmpRatio, TS_U32 u32Align)
{
    TS_U32 u32BitWidth;
    TS_U32 u32Size = 0;
    TS_U32 u32Stride = 0;
    TS_U32 u32RawCmpRatio = 1600;
...
__inline static TS_U32 VI_GetRawBufferSize(TS_U32 u32Width, TS_U32 u32Height,
                                           PIXEL_FORMAT_E enPixelFormat, COMPRESS_MODE_E enCmpMode, TS_U32 u32Align)
{
    return VI_GetRawBufferSizeEx(u32Width, u32Height, enPixelFormat, enCmpMode, 0, u32Align);
}

__inline static TS_U32 VDEC_GetPicBufferSize(PAYLOAD_TYPE_E enType, TS_U32 u32Width,
                                             TS_U32 u32Height,
                                             PIXEL_FORMAT_E enPixelFormat, DATA_BITWIDTH_E enBitWidth, TS_U32 u32Align)
{
    TS_U32 u32AlignWidth, u32AlignHeight;
    TS_U32 u32Size = 0;
...
__inline static TS_U32 VDEC_GetTmvBufferSize(PAYLOAD_TYPE_E enType, TS_U32 u32Width, TS_U32 u32Height)
{
    TS_U32 WidthInMb, HeightInMb;
    TS_U32 ColMbSize;
    TS_U32 u32Size = 0;
...
__inline static TS_U32 VENC_GetRefPicInfoBufferSize(PAYLOAD_TYPE_E enType, TS_U32 u32Width, TS_U32 u32Height,
                                                    TS_U32 u32Align)
{
    TS_U32 u32Size;
    TS_U32 u32AlignWidth, u32AlignHeight;
    TS_U32 u32TmvSize, u32PmeSize, u32PmeInfoSize;
...
__inline static TS_U32 VENC_GetRefBufferSize(PAYLOAD_TYPE_E enType, TS_U32 u32Width, TS_U32 u32Height,
                                             DATA_BITWIDTH_E enBitWidth, TS_U32 u32Align)
{
    TS_U32 u32Size = 0;
    TS_U32 u32AlignWidth, u32AlignHeight, u32BitWidth;
    TS_U32 u32YHeaderSize, u32CHeaderSize, u32YSize, u32CSize;
...
__inline static TS_U32 VENC_GetQpmapSizeStride(TS_U32 u32Width)
{
    if (u32Width > TS_MAXINUM_LIMIT) {
        return 0;
    }
...
__inline static TS_U32 VENC_GetQpmapSize(TS_U32 u32Width, TS_U32 u32Height)
{
    TS_U32 u32Stride, u32AlignHeight;
...
__inline static TS_U32 VENC_GetSkipWeightSizeStride(PAYLOAD_TYPE_E enType, TS_U32 u32Width)
{
    TS_U32 u32Stride;
...
__inline static TS_U32 VENC_GetSkipWeightSize(PAYLOAD_TYPE_E enType, TS_U32 u32Width, TS_U32 u32Height)
{
    TS_U32 u32Stride, u32AlignHeight;
