...
export TARGET_UBOOT_DEFCONFIG="ts_tx5215dv300_aio_v2p0_defconfig"
export TARGET_KERNEL_DEFCONFIG="ts_tx52xx_aio_flash_v2p0_defconfig"
export TARGET_KERNEL_RAMDISK_DEFCONFIG="ts_tx52xx_aio_ramdisk_defconfig"
export TARGET_DTB="ts-tx5215dv300-v2p0-aio.dtb"
export TARGET_FIT_ITS="ts-tx5215dv300-aio.its"
export TARGET_FIT_ITB="ts-tx5215dv300-aio.itb"
export TARGET_FIT_ITB_RAMDISK="ts-tx5215dv300-aio-ramdisk.itb"
