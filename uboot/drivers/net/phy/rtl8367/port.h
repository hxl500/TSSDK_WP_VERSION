...
extern rtk_api_ret_t rtk_port_phyEnable_set(rtk_port_t port, rtk_enable_t enable);
extern rtk_api_ret_t rtk_port_phyEnable_get(rtk_port_t port, rtk_enable_t *pEnable);
