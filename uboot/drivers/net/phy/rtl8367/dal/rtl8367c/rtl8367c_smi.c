...
extern int eth_switch_mdio_read(int mdio_addr, int mdio_reg);
extern int eth_switch_mdio_write(int mdio_addr, 
				int mdio_reg, u16 mdio_val);
void MDC_MDIO_WRITE(rtk_uint32 preamble_len,
	rtk_uint32 phy_id, rtk_uint32 register_id, rtk_uint32 data)
{
	eth_switch_mdio_write(phy_id, register_id, data);
}

void MDC_MDIO_READ(rtk_uint32 preamble_len,
	rtk_uint32 phy_id, rtk_uint32 register_id, rtk_uint32 *pData)
{
	*pData = eth_switch_mdio_read(phy_id, register_id);
}
