 ...
 *      - ENABLE
 */
rtk_api_ret_t dal_rtl8367c_port_phyEnable_set(rtk_port_t port, rtk_enable_t enable)
{
    rtk_api_ret_t retVal;
    rtk_uint32 data;
 ...
 *      - ENABLE
 */
rtk_api_ret_t dal_rtl8367c_port_phyEnable_get(rtk_port_t port, rtk_enable_t *pEnable)
{
    rtk_api_ret_t retVal;
    rtk_uint32 data;
