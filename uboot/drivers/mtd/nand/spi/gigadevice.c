...
static const struct mtd_ooblayout_ops esmt_ooblayout = {
	...
	.rfree = esmt_ooblayout_free,
};


#define COMMON_STATUS_ECC_MASK		GENMASK(5, 4)
#define COMMON_STATUS_ECC_NO_BITFLIPS	(0 << 4)
#define COMMON_STATUS_ECC_1TO4_BITFLIPS	(1 << 4)
//#define COMMON_STATUS_ECC_4TO8_BITFLIPS	(2 << 4)
#define COMMON_STATUS_ECC_4TO8_MP_BITFLIPS	(3 << 4)

static int esmt_ecc_get_status(struct spinand_device *spinand, u8 status)
{

	switch (status & COMMON_STATUS_ECC_MASK) {
	case STATUS_ECC_NO_BITFLIPS:
		return 0;
	...
	case COMMON_STATUS_ECC_1TO4_BITFLIPS:
		return 4;

	//case COMMON_STATUS_ECC_4TO8_BITFLIPS:
		//return 8;

	case COMMON_STATUS_ECC_4TO8_MP_BITFLIPS:
		return 8;
...
static const struct spinand_info gigadevice_spinand_table[] = {
	SPINAND_INFO("F50L1G41LB", 0x01,
		     ...
		     0,
		     SPINAND_ECCINFO(&esmt_ooblayout,
				     esmt_ecc_get_status)),
