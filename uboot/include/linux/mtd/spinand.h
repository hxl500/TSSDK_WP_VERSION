...
extern const struct spinand_manufacturer kowin_spinand_manufacturer;
extern const struct spinand_manufacturer heyangtek_spinand_manufacturer;
extern const struct spinand_manufacturer foresee_spinand_manufacturer;
extern const struct spinand_manufacturer ts_onfi_spinand_manufacturer;
...
int spinand_read_page(struct spinand_device *spinand,
			     const struct nand_page_io_req *req, bool ecc_enabled);
