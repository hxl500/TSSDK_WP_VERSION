...
#ifndef __TSINGMICRO_TX5215CV200_PTZ_H
#define __TSINGMICRO_TX5215CV200_PTZ_H
...
#define CONFIG_EXTRA_ENV_SETTINGS					\
		"boardname=TS-TX5215CV200-PTZ\0" \
		"fip_name=fip_tx5215cv200_ptz.bin\0" \
		"kernel_name=ts-tx5215cv200-ptz.itb\0"  \
		"kernel_ramfs_name=ts-tx5215cv200-ptz-ramdisk.itb\0" \
		...
		"mtdparts=mtdparts=f1000000.spi.0:512K(boot),4M(kernel),3M(romfs)ro,7M(user),-(root) \0"\
