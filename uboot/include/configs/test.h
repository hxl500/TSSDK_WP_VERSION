...
/*
 * Configuration for Tsingmicro TX5239
 * (C) Copyright 2021 Tsingmicro, Inc.
 *
 */

#ifndef __TSINGMICRO_TX5239DV200_IPC_H
#define __TSINGMICRO_TX5239DV200_IPC_H
...
#define CONFIG_EXTRA_ENV_SETTINGS					\
		"boardname=TS-TX5239DV200-IPC\0" \
		"fip_name=fip_tx5239dv200_ipcrd.bin\0" \
		"kernel_name=ts-tx5239dv200-ipc.itb\0"  \
		"kernel_ramfs_name=ts-tx5239dv200-ipc-ramdisk.itb\0" \
