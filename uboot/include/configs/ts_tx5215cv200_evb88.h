...
#ifndef __TSINGMICRO_TX5215CV200_EVB88_H
#define __TSINGMICRO_TX5215CV200_EVB88_H
...
#define TS_KERNEL_MTD_SIZE 0x400000
...
#define TS_RAMDISK_1	TS_ROOTFS_1
#define TS_USER_1		0x4180000	//65.5M
#define TS_ROOTFS_MTD_SIZE 0x3c00000
#endif
...
#define CONFIG_EXTRA_ENV_SETTINGS					\
		"boardname=TS-TX5215CV200-EVB88\0" \
		"fip_name=fip_tx5215cv200_evb88.bin\0" \
		"kernel_name=ts-tx5215cv200-evb88.itb\0"  \
		"kernel_ramfs_name=ts-tx5215cv200-evb88-ramdisk.itb\0" \
		...
		"mtdroot=ubi.mtd=2,2048 root=ubi0:rootfs rootfstype=ubifs rw  mtdparts=spi0.0:512K(boot),5M(kernel),60M(rootfs),-(ubi2) \0"\
