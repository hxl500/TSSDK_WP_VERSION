...
struct vb2_buffer {
	...
	u32		cnt_buf_done;
#else
	u32		cnt_mem_alloc_dummy;
	u32		cnt_mem_put_dummy;
	u32		cnt_mem_get_dmabuf_dummy;
	u32		cnt_mem_get_userptr_dummy;
	u32		cnt_mem_put_userptr_dummy;
	u32		cnt_mem_prepare_dummy;
	u32		cnt_mem_finish_dummy;
	u32		cnt_mem_attach_dmabuf_dummy;
	u32		cnt_mem_detach_dmabuf_dummy;
	u32		cnt_mem_map_dmabuf_dummy;
	u32		cnt_mem_unmap_dmabuf_dummy;
	u32		cnt_mem_vaddr_dummy;
	u32		cnt_mem_cookie_dummy;
	u32		cnt_mem_num_users_dummy;
	u32		cnt_mem_mmap_dummy;
	u32		cnt_buf_init_dummy;
	u32		cnt_buf_prepare_dummy;
	u32		cnt_buf_finish_dummy;
	u32		cnt_buf_cleanup_dummy;
	u32		cnt_buf_queue_dummy;
	u32		cnt_buf_done_dummy;
#endif
};
