...
#else
	int (*vidioc_g_register_dummy)(struct file *file, void *fh,
				 struct v4l2_dbg_register *reg);
	int (*vidioc_s_register_dummy)(struct file *file, void *fh,
				 const struct v4l2_dbg_register *reg);

	int (*vidioc_g_chip_info_dummy)(struct file *file, void *fh,
				  struct v4l2_dbg_chip_info *chip);
#endif
