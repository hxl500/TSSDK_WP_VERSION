...
struct v4l2_subdev_core_ops {
	...
	long (*compat_ioctl32)(struct v4l2_subdev *sd, unsigned int cmd,
			       unsigned long arg);
#else
	long (*compat_ioctl32_dummy)(struct v4l2_subdev *sd, unsigned int cmd,
			       unsigned long arg);
#endif
...
#else
	int (*g_register_dummy)(struct v4l2_subdev *sd, struct v4l2_dbg_register *reg);
	int (*s_register_dummy)(struct v4l2_subdev *sd, const struct v4l2_dbg_register *reg);
#endif
