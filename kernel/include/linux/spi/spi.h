...
static inline struct spi_message *spi_message_alloc(unsigned int ntrans, gfp_t flags)
{
...
#ifdef	CONFIG_SPI
extern int
spi_register_board_info(struct spi_board_info const *info, unsigned int n);
#else
