...
#pragma pack(1)
struct ts_codec_ai_drv_proc_status {
	unsigned char dev_id;
	unsigned int int_cnt;		/* interrupt count */
	unsigned int fifo_cnt;		/* fifo overflow intr count */
	unsigned int buff_int;		/* dma buffer full intr count */
	unsigned int frm_time;		/* the time between two frames */
	unsigned int max_frm_time;	/* the longest time between two frames */
	unsigned int tran_len;		/* one dma transfer len(byte) */
	unsigned int isr_time;		/* the time of dma intr*/
	unsigned int max_isr_time;	/* the longest time of dma intr */
	unsigned int cb_phy;		/* dma buffer physical address */
	unsigned int cb_size;		/* dma buffer size */
	unsigned int roff_set;		/* dma buffer read pointer offset base dma */
	unsigned int woff_set;		/* dma buffer write pointer offset base dma */
};

struct ts_codec_ao_drv_proc_status {
	unsigned char dev_id;
	unsigned int int_cnt;		/* interrupt count */
	unsigned int fifo_cnt;		/* fifo overflow intr count */
	unsigned int buff_int;		/* dma buffer full intr count */
