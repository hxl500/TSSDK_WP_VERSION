...
enum {
	TS_CODEC_INNTER_CODEC_V1_CARD_IDX	= 0,
	TS_CODEC_I2S0_CARD_IDX				= 1,
	TS_CODEC_I2S1_CARD_IDX				= 2,
	TS_CODEC_PDMIC_CARD_IDX			= 3,
	TS_CODEC_HDMI_AUDIO_CARD_IDX		= 4,
	TS_CODEC_INNTER_CODEC_V2_CARD_IDX	= 5,
	TS_CODEC_INNTER_CODEC_V3_CARD_IDX	= 6,
	TS_CODEC_PDMIC_CARD_IDX7			= 7,
	TS_CODEC_PDMIC_CARD_IDX8			= 8,
	TS_CODEC_PDMIC_CARD_IDX9			= 9,
};
