...
extern const struct regmap_config es8156_regmap_config;
int es8156_probe_internal(struct device *dev,
								struct regmap *regmap);
void es8156_i2c_remove_internel(struct device *dev);

void es8156_shutdown(struct device *dev);
