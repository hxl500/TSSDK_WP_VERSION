...
#define ES8323_MASTERMODE_BCLKDIV		(0 << 0)
#define ES8323_MASTERMODE_BCLK_NORMAL	(0 << 5)
#define ES8323_MASTERMODE_BCLK_INV		(1 << 5)
#define ES8323_MASTERMODE_MCLKDIV2		(1 << 6)
#define ES8323_MASTERMODE_MSC			(1 << 7)
...
#define ES8323_ADCCONTROL4_ADCFORMAT_MASK		(3 << 0)
#define ES8323_ADCCONTROL4_ADCFORMAT_I2S		(0 << 0)
#define ES8323_ADCCONTROL4_ADCFORMAT_LJUST		(1 << 0)
#define ES8323_ADCCONTROL4_ADCFORMAT_RJUST		(2 << 0)
#define ES8323_ADCCONTROL4_ADCFORMAT_PCM		(3 << 0)
#define ES8323_ADCCONTROL4_ADCWL_SHIFT			2
#define ES8323_ADCCONTROL4_ADCWL_MASK			(7 << 2)
enum {
	ADCWL_24BIT,
	ADCWL_20BIT,
	ADCWL_18BIT,
...
#define ES8323_ADCCONTROL4_ADCLRP_I2S_POL_NORMAL	(0 << 5)
#define ES8323_ADCCONTROL4_ADCLRP_I2S_POL_INV		(1 << 5)
#define ES8323_ADCCONTROL4_ADCLRP_PCM_MSB_CLK2		(0 << 5)
#define ES8323_ADCCONTROL4_ADCLRP_PCM_MSB_CLK1		(1 << 5)
...
#define ES8323_DACCONTROL1_DACFORMAT_MASK			(3 << 1)
#define ES8323_DACCONTROL1_DACFORMAT_I2S			(0 << 1)
#define ES8323_DACCONTROL1_DACFORMAT_LJUST			(1 << 1)
#define ES8323_DACCONTROL1_DACFORMAT_RJUST			(2 << 1)
#define ES8323_DACCONTROL1_DACFORMAT_PCM			(3 << 1)
#define ES8323_DACCONTROL1_DACWL_SHIFT				3
#define ES8323_DACCONTROL1_DACWL_MASK				(7 << 3)
enum {
	DACWL_24BIT,
	DACWL_20BIT,
	DACWL_18BIT,
...
#define ES8323_DACCONTROL1_DACLRP_I2S_POL_NORMAL	(0 << 6)
#define ES8323_DACCONTROL1_DACLRP_I2S_POL_INV		(1 << 6)
#define ES8323_DACCONTROL1_DACLRP_PCM_MSB_CLK2		(0 << 6)
#define ES8323_DACCONTROL1_DACLRP_PCM_MSB_CLK1		(1 << 6)
#define ES8323_DACCONTROL1_LRSWAP					(1 << 7)


#define ES8323_DACCONTROL2		0x18

#define ES8323_DACCONTROL3		0x19
#define ES8323_DACCONTROL3_AUTOMUTE			(1 << 2)
#define ES8323_DACCONTROL3_DACMUTE			(1 << 2)
#define ES8323_DACCONTROL3_DACUNMUTE		(0 << 2)
#define ES8323_DACCONTROL3_LEFTGAINVOL		(1 << 3)
#define ES8323_DACCONTROL3_DACSOFTRAMP		(1 << 5)
#define ES8323_DACCONTROL3_DACRAMPRATE		(3 << 6)
