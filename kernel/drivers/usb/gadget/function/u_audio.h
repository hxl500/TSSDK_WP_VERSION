...
#define TSUAC_CHIP_IOC_MAGIC  'j'
#define TS_UAC_PLAYER_ALT      _IOR(TSUAC_CHIP_IOC_MAGIC,  1, unsigned int)
#define TS_UAC_CAPTURE_ALT      _IOR(TSUAC_CHIP_IOC_MAGIC,  2, unsigned int)
