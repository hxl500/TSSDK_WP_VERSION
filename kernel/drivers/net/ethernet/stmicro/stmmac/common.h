...
static inline void stmmac_writel(u32 val, void __iomem *addr)
{
	if (in_irq())
...
static inline u32 stmmac_readl(const void __iomem *addr)
{
	if (in_irq())
...
#define stmmac_writel writel
#define stmmac_readl readl

#endif

#define stmmac_readl_poll_timeout(addr, val, cond, delay_us, timeout_us) \
	readx_poll_timeout(stmmac_readl, addr, val, cond, delay_us, timeout_us)

#define stmmac_readl_poll_timeout_atomic(addr, val, cond, delay_us, timeout_us) \
	readx_poll_timeout_atomic(stmmac_readl, addr, val, cond, delay_us, timeout_us)
/**
