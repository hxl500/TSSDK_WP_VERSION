...
struct sdhci_ops {
#if defined(CONFIG_MMC_SDHCI_IO_ACCESSORS) || defined(CONFIG_ARCH_TS_TX536)
...
#endif /* CONFIG_MMC_SDHCI_IO_ACCESSORS || CONFIG_ARCH_TS_TX536 */
