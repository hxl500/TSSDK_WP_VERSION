...
#define DMAC_CHEN_H		0x020 /* R/W DMAC Channel Enable */
#define DMAC_CHEN2_L		0x018 /* R/W DMAC Channel Enable 00-31 */
#define DMAC_CHEN2_H		0x01C /* R/W DMAC Channel Enable 32-63 */
#define DMAC_CHSUSPREG		0x020 /* R/W DMAC Channel Suspend */
#define DMAC_CHSUSP		0x020 /* R/W DMAC Suspend Enable */
#define DMAC_CHSUSP_L	0x020 /* R/W DMAC Suspend Enable 00-16 */
#define DMAC_CHSUSP_H	0x024 /* R/W DMAC Suspend Enable 17-31*/
...
/* DMAC_CHEN_L (max channel <= 8) */
#define DMAC_CHAN_L_EN_SHIFT		0
#define DMAC_CHAN_L_EN_WE_SHIFT		8
#define DMAC_CHAN_L_EN_SUSP_SHIFT		16
#define DMAC_CHAN_L_EN_SUSP_WE_SHIFT 	24

/* DMAC_CHEN_H (max channel <= 8) */
#define DMAC_CHAN_H_EN_ABORT_SHIFT		0
#define DMAC_CHAN_H_EN_ABORT_WE_SHIFT 	8

/* DMAC_CHEN2_L (max channel > 8)*/
/* chan num > 8 && chan num <= 16 */
#define DMAC_CHAN2_L_EN_SHIFT			0
#define DMAC_CHAN2_L_EN_WE_SHIFT		16

/* DMAC_CHEN2_H (max channel > 8)*/
/* chan num > 16 && chan num <= 32 */
#define DMAC_CHAN2_H_EN_SHIFT			0
#define DMAC_CHAN2_H_EN_WE_SHIFT		16

/* DMAC_CHSUSP_L (max channel > 8)*/
/* chan num > 8 && chan num <= 16 */
#define DMAC_CHSUSP_L_EN_SUSP_SHIFT		0
#define DMAC_CHSUSP_L_EN_SUSP_WE_SHIFT	16

/* DMAC_CHSUSP_H (max channel > 8)*/
/* chan num > 16 && chan num <= 32 */
#define DMAC_CHSUSP_H_EN_SUSP_SHIFT		0
#define DMAC_CHSUSP_H_EN_SUSP_WE_SHIFT	16
