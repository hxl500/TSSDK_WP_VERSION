...
#define TX5215_SMU_CHIP_WAKE_UP_CFG		0x40
#define TX5215_SMU_WDT_RESET_CTL		0x10
#define TX5215_SMU_RTC_CLK_CFG			0x80

struct regmap *g_smu;


static const struct tsm_smu_value tx5215_defaults[] __initconst = {
	{"chip wake up", TX5215_SMU_CHIP_WAKE_UP_CFG, 0x1, 0x3, 0},
	{"top wdt reset", TX5215_SMU_WDT_RESET_CTL, 0x1, 0x1, 4},
	{"sec wdt reset", TX5215_SMU_WDT_RESET_CTL, 0x1, 0x1, 5},
	{"rtc wake up", TX5215_SMU_RTC_CLK_CFG, 0x3, 0x3, 0},
};

static const struct tsm_smu_info tx5215_smu __initconst = {
	.values = tx5215_defaults,
	.num_values = ARRAY_SIZE(tx5215_defaults),
};

static const struct of_device_id tsm_smu_dt_match[] __initconst = {
	{
		.compatible = "ts,tx5215-smu",
		.data = (void *)&tx5215_smu,
	},
	{ /* sentinel */ },
};
...
{
	regmap_write(g_smu, TX5215_SMU_WDT_RESET_CTL, 0x1);
