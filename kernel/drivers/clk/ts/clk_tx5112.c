...
static const char * const i2c_icclk_sels[] = { &osc_in[0], "pll0_d2" };
static const char * const uart_sclk_sels[] = { &osc_in[0], "pll0_d4" };
static const char * const spi_ssiiclk_sels[] = { &osc_in[0], "pll1" };
static const char * const rne_cclk_sels[] = {&osc_in[0], "pll0", &osc_in[0], "pll1" };
static const char * const rne_clk_sels[] = {  &osc_in[0], "pll1" };
...
#define DIV(id, off, shift, width, we, sync) DIV_FLAGS(id, off, shift, width, we, sync, 0, 0)
...
#define DIV_LIST \
	...
	DIV(TS_CLK_TX5112_ISP_SCLK, ISP_SCLK_CFG, 16, 5, 0, SYNC_INVALID) \
	DIV(TS_CLK_TX5112_VPE_CCLK, VPE_CCLK_CFG, 16, 5, 0, SYNC_INVALID) \
	...
	DIV(TS_CLK_TX5112_RNE_CCLK, RNE_CCLK_CFG, 16, 6, 0, SYNC_INVALID) \
...
#define GATE_LIST \
	...
	GATE(TS_CLK_TX5112_MIPI_PHY_PCLK, VI_BUS_CLK_EN, 11, 0) \
	...
	GATE(TS_CLK_TX5112_VPU_PCLK, VPU_CLK_CFG, 3, 0) \
...
#define MUX_LIST \
	...
	MUX_PARENTS(TS_CLK_TX5112_SD0_CCLK_SMP_PH, sd0_cclk_smpl_sels, SD_CLK_OFFSET, 20, 4, WE_INVALID, SYNC_INVALID) \
	MUX_PARENTS(TS_CLK_TX5112_SD0_CCLK_DRV_PH, sd0_cclk_drv_sels, SD_CLK_OFFSET, 16, 4, WE_INVALID, SYNC_INVALID) \
	MUX_PARENTS(TS_CLK_TX5112_SD1_CCLK, sd1_cclk_sels, SDHC1_CCLK_CFG, 8, 1, 0, SYNC_INVALID) \
	MUX_PARENTS(TS_CLK_TX5112_SD1_CCLK_SMP_PH, sd1_cclk_smpl_sels, SD_CLK_OFFSET, 28, 4, WE_INVALID, SYNC_INVALID) \
	MUX_PARENTS(TS_CLK_TX5112_SD1_CCLK_DRV_PH, sd1_cclk_drv_sels, SD_CLK_OFFSET, 24, 4, WE_INVALID, SYNC_INVALID) \
	MUX_PARENTS(TS_CLK_TX5112_OSPI_REF_CLK, ospi_ref_clk_sels, OSPI_RCLK_CFG, 8, 1, 0, SYNC_INVALID) \
	MUX_PARENTS(TS_CLK_TX5112_USB_REF_CLK, usb_phy_clk_sels, USB_PHY_CLK_CFG, 8, 1, 0, SYNC_INVALID) \
	...
	MUX_PARENTS(TS_CLK_TX5112_RNE_CCLK, rne_cclk_sels, RNE_CCLK_CFG, 10, 2, 0, SYNC_INVALID) \
...
#define COMP_LIST \
	...
	COMP_GATE_ONLY(TS_CLK_TX5112_SD0_CCLK_SMPL) \
	COMP_GATE_ONLY(TS_CLK_TX5112_SD0_CCLK_DRV) \
	COMP_GATE_ONLY(TS_CLK_TX5112_SD0_CCLK_SMP_EDGE) \
	COMP_GATE_ONLY(TS_CLK_TX5112_SD0_CCLK_DRV_EDGE) \
	COMP(TS_CLK_TX5112_SD1_CCLK) \
	COMP_GATE_ONLY(TS_CLK_TX5112_SD1_CCLK_SMPL) \
	COMP_GATE_ONLY(TS_CLK_TX5112_SD1_CCLK_DRV) \
	...
	COMP_NODIV(TS_CLK_TX5112_USB_REF_CLK) \
	...
	COMP_GATE_ONLY(TS_CLK_TX5112_MIPI_PHY_PCLK) \
	...
	COMP_GATE_ONLY(TS_CLK_TX5112_VPU_PCLK) \
	COMP_GATE_ONLY(TS_CLK_TX5112_H264_ACLK) \
	COMP(TS_CLK_TX5112_CHIP_OCLK_I3) \
	COMP(TS_CLK_TX5112_CHIP_OCLK_I2) \
	COMP(TS_CLK_TX5112_CHIP_OCLK_I1) \
	COMP(TS_CLK_TX5112_CHIP_OCLK_I0)
					...
					const char *parent)
{
	...
	if (params->mux == TS_CLK_MUX_NONE) {
		...
		if ((params->mux >= MUXIFY(TS_CLK_TX5112_UART0_SCLK))
			&& (params->mux <= MUXIFY(TS_CLK_TX5112_UART1_SCLK))) {
			flags = CLK_SET_RATE_NO_REPARENT;
		}

		parent_names = ts_tx5112_muxes[params->mux].parent_names;
		num_parents = ts_tx5112_muxes[params->mux].num_parents;
	}
	...
	if (params->div == TS_CLK_DIV_NONE) {
		...
		if (clk_tx5112_is_frac_divider(name)) {
			...
			div = (struct clk_fractional_divider *)ts_create_fractional_div_legacy(&ts_tx5112_divs[div_id], base);
			hw = &((struct clk_fractional_divider *)div)->hw;
		} else {
			div_ops = &clk_divider_ops;
			div = (struct clk_divider *)ts_create_div(&ts_tx5112_divs[div_id], base);
...
static struct clk *tx_tx5112_clks[TS_CLK_TX5112_MAX];
...
static int clk_tx5112_register_plls(struct ts_clk_params *paras)
{
	...
	clk_dm(TS_CLK_TX5112_PLL0_D2, "pll0_d2",
		ts_clk_fixed_divider("pll0_d2", "pll0", 2));
	clk_dm(TS_CLK_TX5112_PLL0_D4, "pll0_d4",
		ts_clk_fixed_divider("pll0_d4", "pll0", 4));
	clk_dm(TS_CLK_TX5112_PLL0_D5, "pll0_d5",
		ts_clk_fixed_divider("pll0_d5", "pll0", 5));
	clk_dm(TS_CLK_TX5112_PLL0_D8, "pll0_d8",
		ts_clk_fixed_divider("pll0_d8", "pll0", 8));
	clk_dm(TS_CLK_TX5112_PLL0_D10, "pll0_d10",
		ts_clk_fixed_divider("pll0_d10", "pll0", 10));
	clk_dm(TS_CLK_TX5112_PLL0_D27, "pll0_d10",
		ts_clk_fixed_divider("pll0_d10", "pll0", 27));
	clk_dm(TS_CLK_TX5112_PLL0_D40, "pll0_d40",
		ts_clk_fixed_divider("pll0_d40", "pll0", 40));
	clk_dm(TS_CLK_TX5112_PLL1_D3, "pll1_d3",
		ts_clk_fixed_divider("pll1_d3", "pll1", 3));
	clk_dm(TS_CLK_TX5112_PLL1_D4, "pll1_d4",
		ts_clk_fixed_divider("pll1_d4", "pll1", 4));
	clk_dm(TS_CLK_TX5112_PLL1_D6, "pll1_d6",
		ts_clk_fixed_divider("pll1_d6", "pll1", 6));
	clk_dm(TS_CLK_TX5112_PLL1_D8, "pll1_d8",
	...
	tx_tx5112_clks[TS_CLK_TX5112_OSC_24M] = pclk;
...
#define REGISTER_COMP(id, name) \
	...
	clk_dm(TS_CLK_TX5112_SD0_CLK_SMP_SHIFT_ALIEND, "sd0_cclk_aligned",
		ts_clk_fixed_divider("sd0_cclk_aligned", "sd0_cclk", 1));
	clk_dm(TS_CLK_TX5112_SD0_CLK_SMP_SHIFT_1_10, "sd0_cclk_shift_1_10",
		ts_clk_fixed_divider("sd0_cclk_shift_1_10", "sd0_cclk", 1));
	clk_dm(TS_CLK_TX5112_SD0_CLK_SMP_SHIFT_2_10, "sd0_cclk_shift_2_10",
		ts_clk_fixed_divider("sd0_cclk_shift_2_10", "sd0_cclk", 1));
	clk_dm(TS_CLK_TX5112_SD0_CLK_SMP_SHIFT_3_10, "sd0_cclk_shift_3_10",
		ts_clk_fixed_divider("sd0_cclk_shift_3_10", "sd0_cclk", 1));
	clk_dm(TS_CLK_TX5112_SD0_CLK_SMP_SHIFT_4_10, "sd0_cclk_shift_4_10",
		ts_clk_fixed_divider("sd0_cclk_shift_4_10", "sd0_cclk", 1));
	clk_dm(TS_CLK_TX5112_SD0_CLK_SMP_SHIFT_5_10, "sd0_cclk_shift_5_10",
		ts_clk_fixed_divider("sd0_cclk_shift_5_10", "sd0_cclk", 1));
	clk_dm(TS_CLK_TX5112_SD0_CLK_SMP_SHIFT_6_10, "sd0_cclk_shift_6_10",
		ts_clk_fixed_divider("sd0_cclk_shift_6_10", "sd0_cclk", 1));
	clk_dm(TS_CLK_TX5112_SD0_CLK_SMP_SHIFT_7_10, "sd0_cclk_shift_7_10",
		ts_clk_fixed_divider("sd0_cclk_shift_7_10", "sd0_cclk", 1));
	clk_dm(TS_CLK_TX5112_SD0_CLK_SMP_SHIFT_8_10, "sd0_cclk_shift_8_10",
		ts_clk_fixed_divider("sd0_cclk_shift_8_10", "sd0_cclk", 1));
	clk_dm(TS_CLK_TX5112_SD0_CLK_SMP_SHIFT_9_10, "sd0_cclk_shift_9_10",
		ts_clk_fixed_divider("sd0_cclk_shift_9_10", "sd0_cclk", 1));

	REGISTER_COMP(TS_CLK_TX5112_SD1_CCLK, "sd1_cclk");
	clk_dm(TS_CLK_TX5112_SD1_CLK_SMP_SHIFT_ALIEND, "sd1_cclk_aligned",
		ts_clk_fixed_divider("sd1_cclk_aligned", "sd1_cclk", 1));
	clk_dm(TS_CLK_TX5112_SD1_CLK_SMP_SHIFT_1_10, "sd1_cclk_shift_1_10",
		ts_clk_fixed_divider("sd1_cclk_shift_1_10", "sd1_cclk", 1));
	clk_dm(TS_CLK_TX5112_SD1_CLK_SMP_SHIFT_2_10, "sd1_cclk_shift_2_10",
		ts_clk_fixed_divider("sd1_cclk_shift_2_10", "sd1_cclk", 1));
	clk_dm(TS_CLK_TX5112_SD1_CLK_SMP_SHIFT_3_10, "sd1_cclk_shift_3_10",
		ts_clk_fixed_divider("sd1_cclk_shift_3_10", "sd1_cclk", 1));
	clk_dm(TS_CLK_TX5112_SD1_CLK_SMP_SHIFT_4_10, "sd1_cclk_shift_4_10",
		ts_clk_fixed_divider("sd1_cclk_shift_4_10", "sd1_cclk", 1));
	clk_dm(TS_CLK_TX5112_SD1_CLK_SMP_SHIFT_5_10, "sd1_cclk_shift_5_10",
		ts_clk_fixed_divider("sd1_cclk_shift_5_10", "sd1_cclk", 1));
	clk_dm(TS_CLK_TX5112_SD1_CLK_SMP_SHIFT_6_10, "sd1_cclk_shift_6_10",
		ts_clk_fixed_divider("sd1_cclk_shift_6_10", "sd1_cclk", 1));
	clk_dm(TS_CLK_TX5112_SD1_CLK_SMP_SHIFT_7_10, "sd1_cclk_shift_7_10",
		ts_clk_fixed_divider("sd1_cclk_shift_7_10", "sd1_cclk", 1));
	clk_dm(TS_CLK_TX5112_SD1_CLK_SMP_SHIFT_8_10, "sd1_cclk_shift_8_10",
		ts_clk_fixed_divider("sd1_cclk_shift_8_10", "sd1_cclk", 1));
	clk_dm(TS_CLK_TX5112_SD1_CLK_SMP_SHIFT_9_10, "sd1_cclk_shift_9_10",
		ts_clk_fixed_divider("sd1_cclk_shift_9_10", "sd1_cclk", 1));

	REGISTER_COMP(TS_CLK_TX5112_OSPI_REF_CLK, "ospi_ref_clk");
	REGISTER_COMP(TS_CLK_TX5112_USB_REF_CLK, "usb_phy_ref_clk");
...
#define REGISTER_DIV(id, name, parent) do {\
		const struct ts_div_params *params = &ts_tx5112_divs[DIVIFY(id)]; \
		clk_dm(id, name, \
...
#define REGISTER_GATE(id, name, parent) do { \
	...
	REGISTER_GATE(TS_CLK_TX5112_SD0_CCLK_SMPL, "sd0_cclk_smpl", "pll0");
	REGISTER_GATE(TS_CLK_TX5112_SD0_CCLK_DRV, "sd0_cclk_drv", "pll0");
	REGISTER_GATE(TS_CLK_TX5112_SD1_CCLK_SMPL, "sd1_cclk_smpl", "pll0");
	REGISTER_GATE(TS_CLK_TX5112_SD1_CCLK_DRV, "sd1_cclk_drv", "pll0");
	...
	REGISTER_GATE(TS_CLK_TX5112_AUD_CODEC_HCLK, "aud_codec_hclk", "core_ahb_clk");
	...
	REGISTER_GATE(TS_CLK_TX5112_MIPI_PHY_PCLK, "mipi_phy_pclk", "vi_apb_clk");
	...
	REGISTER_GATE(TS_CLK_TX5112_AMR_ACLK, "amr_aclk", "ai_aclk");
	REGISTER_GATE(TS_CLK_TX5112_AI_ACLK, "ai_aclk", "pll0");
	...
	REGISTER_GATE(TS_CLK_TX5112_H265_PCLK, "h265_pclk", "h265_cclk");
	REGISTER_GATE(TS_CLK_TX5112_H265_ACLK, "h265_aclk", "vpu_aclk");
	REGISTER_GATE(TS_CLK_TX5112_VPU_PCLK,  "vpu_pclk", "vpu_aclk");
...
static void clk_tx5112_init_clk_data(struct ts_clk_params *paras)
{
	struct clk_onecell_data *clk_data = &paras->clk_data;

	clk_data->clks = &tx_tx5112_clks[0];
	clk_data->clk_num = ARRAY_SIZE(tx_tx5112_clks);
}
...
int ts_clk_init_funcs(struct ts_clk_reg_funcs *pfuncs)
{
	...
	pfuncs->init_clk_data = clk_tx5112_init_clk_data;
	return 0;
}
