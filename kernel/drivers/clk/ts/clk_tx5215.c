...
static const char * const top_ahb_clk_sels[] = { &osc_in[0], "pll0_d5" };
...
static const char * const i2c_icclk_sels[] = { &osc_in[0], "pll1_d6" };
static const char * const uart_sclk_sels[] = { &osc_in[0], "pll1_d4" };
static const char * const spi_ssiiclk_sels[] = { &osc_in[0], "pll1_d3" };
static const char * const rne_cclk_sels[] = { "pll0", "pll1" };
static const char * const chip_oclk_sels[] = { "pll0_d8", "pll1_d4", &osc_in[0] };


static struct clk_div_table oclk_div_power_of_two_table[] = {
	{ 0, 1 }, 
    { 1, 3 }, 
    { 2, 5 }, 
    { 3, 9 },
...
static struct clk_div_table oclk_div_mul_two_table[] = {
    { 2, 4 }, 
    { 3, 6 },
    { 4, 8 },
    { 5, 10 },
...
#define DIV(id, off, shift, width, we, sync, flags) DIV_FLAGS(id, off, shift, width, we, sync, flags, 0)
...
#define DIV_LIST \
	...
	DIV_TABLE(TS_CLK_TX5215_CPU_JTAG_CLK, CPU_CLK_CFG1, 16, 3, 22, 23, oclk_div_mul_two_table) \
	...
	DIV_TABLE(TS_CLK_TX5215_SD0_CCLK_DIV1, SDHC0_CCLK_CFG0, 0, 5, 6, 7, oclk_div_mul_two_table) \
	DIV(TS_CLK_TX5215_SD0_CCLK_DIV2, SDHC0_CCLK_CFG0, 16, 4, 6, 7, 0) \
	DIV_TABLE(TS_CLK_TX5215_SD1_CCLK_DIV1, SDHC1_CCLK_CFG0, 0, 5, 6, 7, oclk_div_mul_two_table) \
	DIV(TS_CLK_TX5215_SD1_CCLK_DIV2, SDHC1_CCLK_CFG0, 16, 4, 6, 7, 0) \
	DIV_TABLE(TS_CLK_TX5215_OSPI_REF_CLK, OSPI_RCLK_CFG, 0, 4, 6, 7, oclk_div_mul_two_table) \
	...
	DIV(TS_CLK_TX5215_AUD_DAC_PBCLK_DIV, AUD_DAC_CLK_CFG0, 24, 6, 30, 31, 0) \
	DIV(TS_CLK_TX5215_AUD_DIV_ED_TMR_SRTB, AUD_DAC_CLK_CFG1, 0, 9, 12, 13, 0) \
	...
	DIV_TABLE(TS_CLK_TX5215_CHIP_OCLK_I0, CHIP_OCLK_CFG, 6, 2, WE_INVALID, 1, \
			oclk_div_power_of_two_table) \
	DIV_TABLE(TS_CLK_TX5215_CHIP_OCLK_I1, CHIP_OCLK_CFG, 14, 2, WE_INVALID, 9, \
			oclk_div_power_of_two_table)
...
#define GATE_LIST \
	...
	GATE(TS_CLK_TX5215_CAN1_PCLK, BUS_CLK_EN2, 22) \
	GATE(TS_CLK_TX5215_CAN0_PCLK, BUS_CLK_EN2, 21) \
	...
	GATE(TS_CLK_TX5215_PTP_REF_CLK, GMAC_MAC_CLK_EN, 8) \
	GATE(TS_CLK_TX5215_GMII_TX_CLK, GMAC_MAC_CLK_EN, 6) \
	GATE(TS_CLK_TX5215_MII_RX_CLK, GMAC_MAC_CLK_EN, 0) \
	...
	GATE(TS_CLK_TX5215_AUD_DAC_PBCLK_INV_EN, AUD_DAC_CLK_CFG1, 19) \
	GATE(TS_CLK_TX5215_DIV1_CODEC_DAC_CCLK, AUD_DAC_CLK_CFG1, 18) \
	GATE(TS_CLK_TX5215_DIV0_CODEC_DAC_CCLK, AUD_DAC_CLK_CFG1, 18) \
	GATE(TS_CLK_TX5215_AUD_DAC_PBCLK_DIV, AUD_DAC_CLK_CFG1, 17) \
	GATE(TS_CLK_TX5215_AUD_DIV_ED_TMR_SRTB, AUD_DAC_CLK_CFG1, 16) \
	GATE(TS_CLK_TX5215_DIV1_CODEC_ADC_CCLK, AUD_ADC_CLK_CFG, 24) \
	GATE(TS_CLK_TX5215_DIV0_CODEC_ADC_CCLK, AUD_ADC_CLK_CFG, 24) \
...
#define COMP_LIST \
	...
	COMP_NOMUX(TS_CLK_TX5215_DIV0_CODEC_DAC_CCLK) \
	COMP_NOMUX(TS_CLK_TX5215_AUD_DAC_PBCLK_DIV) \
	COMP_NOMUX(TS_CLK_TX5215_AUD_DIV_ED_TMR_SRTB) \
	COMP_NOMUX(TS_CLK_TX5215_DIV1_CODEC_ADC_CCLK) \
	COMP_NOMUX(TS_CLK_TX5215_DIV0_CODEC_ADC_CCLK) \
...
static char *frac_div_arr[] = {"uart0_sclk", "uart1_sclk", "uart2_sclk"};
					...
					const char *parent)
{
	...
	if (params->mux == TS_CLK_MUX_NONE) {
		...
		if ((params->mux >= MUXIFY(TS_CLK_TX5215_UART0_SCLK))
			&& (params->mux <= MUXIFY(TS_CLK_TX5215_UART2_SCLK))) {
			flags = CLK_SET_RATE_NO_REPARENT;
		}

		parent_names = ts_tx5215_muxes[params->mux].parent_names;
		num_parents = ts_tx5215_muxes[params->mux].num_parents;
	}
	...
	if (params->div == TS_CLK_DIV_NONE) {
		...
		if (clk_tx5215_is_frac_divider(name)) {
			pr_err("----div_id %d frac div\n----", div_id);
			div_ops = &clk_fractional_divider_ops;
			div = (struct clk_fractional_divider *)ts_create_fractional_div_legacy(&ts_tx5215_divs[div_id], base);
			hw = &((struct clk_fractional_divider *)div)->hw;
		} else {
			div_ops = &clk_divider_ops;
			div = (struct clk_divider *)ts_create_div(&ts_tx5215_divs[div_id], base);
...
static struct clk *tx_tx5215_clks[TS_CLK_TX5215_MAX];

static inline void clk_dm(ulong id, const char *name, struct clk *clk)
{
	int ret;

	if (id >= TS_CLK_TX5215_MAX) {
...
static int clk_tx5215_register_plls(struct ts_clk_params *paras)
{
	...
	clk_dm(TS_CLK_TX5215_PLL0_D2, "pll0_d2",
		ts_clk_fixed_divider("pll0_d2", "pll0", 2));
	clk_dm(TS_CLK_TX5215_PLL0_D4, "pll0_d4",
		ts_clk_fixed_divider("pll0_d4", "pll0", 4));
	clk_dm(TS_CLK_TX5215_PLL0_D5, "pll0_d5",
		ts_clk_fixed_divider("pll0_d5", "pll0", 5));
	clk_dm(TS_CLK_TX5215_PLL0_D8, "pll0_d8",
		ts_clk_fixed_divider("pll0_d8", "pll0", 8));
	clk_dm(TS_CLK_TX5215_PLL0_D10, "pll0_d10",
		ts_clk_fixed_divider("pll0_d10", "pll0", 10));
	clk_dm(TS_CLK_TX5215_PLL0_D40, "pll0_d40",
		ts_clk_fixed_divider("pll0_d40", "pll0", 40));

	clk_dm(TS_CLK_TX5215_PLL1_D3, "pll1_d3",
		ts_clk_fixed_divider("pll1_d3", "pll1", 3));
	clk_dm(TS_CLK_TX5215_PLL1_D4, "pll1_d4",
		ts_clk_fixed_divider("pll1_d4", "pll1", 4));
	clk_dm(TS_CLK_TX5215_PLL1_D6, "pll1_d6",
	...
	tx_tx5215_clks[TS_CLK_TX5215_OSC_24M] = pclk;
...
#define REGISTER_COMP(id, name) \
	...
	pr_info("--TS_CLK_MUX_NONE  %d--\n", TS_CLK_MUX_NONE);
	pr_info("--TS_CLK_DIV_NONE  %d--\n", TS_CLK_DIV_NONE);
	pr_info("--TS_CLK_GATE_NONE %d--\n", TS_CLK_GATE_NONE);
	...
	clk_dm(TS_CLK_TX5215_SD0_CCLK_ALIEND, "sd0_cclk_aligned",
		ts_clk_fixed_divider("sd0_cclk_aligned", "sd0_cclk_div2", 1));
	clk_dm(TS_CLK_TX5215_SD0_CCLK_SHIFT_1_10, "sd0_cclk_shift_1_10",
		ts_clk_fixed_divider("sd0_cclk_shift_1_10", "sd0_cclk_div2", 1));
	clk_dm(TS_CLK_TX5215_SD0_CCLK_SHIFT_2_10, "sd0_cclk_shift_2_10",
		ts_clk_fixed_divider("sd0_cclk_shift_2_10", "sd0_cclk_div2", 1));
	clk_dm(TS_CLK_TX5215_SD0_CCLK_SHIFT_3_10, "sd0_cclk_shift_3_10",
		ts_clk_fixed_divider("sd0_cclk_shift_3_10", "sd0_cclk_div2", 1));
	clk_dm(TS_CLK_TX5215_SD0_CCLK_SHIFT_4_10, "sd0_cclk_shift_4_10",
		ts_clk_fixed_divider("sd0_cclk_shift_4_10", "sd0_cclk_div2", 1));
	clk_dm(TS_CLK_TX5215_SD0_CCLK_SHIFT_5_10, "sd0_cclk_shift_5_10",
		ts_clk_fixed_divider("sd0_cclk_shift_5_10", "sd0_cclk_div2", 1));
	clk_dm(TS_CLK_TX5215_SD0_CCLK_SHIFT_6_10, "sd0_cclk_shift_6_10",
		ts_clk_fixed_divider("sd0_cclk_shift_6_10", "sd0_cclk_div2", 1));
	clk_dm(TS_CLK_TX5215_SD0_CCLK_SHIFT_7_10, "sd0_cclk_shift_7_10",
		ts_clk_fixed_divider("sd0_cclk_shift_7_10", "sd0_cclk_div2", 1));
	clk_dm(TS_CLK_TX5215_SD0_CCLK_SHIFT_8_10, "sd0_cclk_shift_8_10",
		ts_clk_fixed_divider("sd0_cclk_shift_8_10", "sd0_cclk_div2", 1));
	clk_dm(TS_CLK_TX5215_SD0_CCLK_SHIFT_9_10, "sd0_cclk_shift_9_10",
		ts_clk_fixed_divider("sd0_cclk_shift_9_10", "sd0_cclk_div2", 1));
	...
	clk_dm(TS_CLK_TX5215_SD1_CCLK_ALIEND, "sd1_cclk_aligned",
		ts_clk_fixed_divider("sd1_cclk_aligned", "sd1_cclk_div2", 1));
	clk_dm(TS_CLK_TX5215_SD1_CCLK_SHIFT_1_10, "sd1_cclk_shift_1_10",
		ts_clk_fixed_divider("sd1_cclk_shift_1_10", "sd1_cclk_div2", 1));
	clk_dm(TS_CLK_TX5215_SD1_CCLK_SHIFT_2_10, "sd1_cclk_shift_2_10",
		ts_clk_fixed_divider("sd1_cclk_shift_2_10", "sd1_cclk_div2", 1));
	clk_dm(TS_CLK_TX5215_SD1_CCLK_SHIFT_3_10, "sd1_cclk_shift_3_10",
		ts_clk_fixed_divider("sd1_cclk_shift_3_10", "sd1_cclk_div2", 1));
	clk_dm(TS_CLK_TX5215_SD1_CCLK_SHIFT_4_10, "sd1_cclk_shift_4_10",
		ts_clk_fixed_divider("sd1_cclk_shift_4_10", "sd1_cclk_div2", 1));
	clk_dm(TS_CLK_TX5215_SD1_CCLK_SHIFT_5_10, "sd1_cclk_shift_5_10",
		ts_clk_fixed_divider("sd1_cclk_shift_5_10", "sd1_cclk_div2", 1));
	clk_dm(TS_CLK_TX5215_SD1_CCLK_SHIFT_6_10, "sd1_cclk_shift_6_10",
		ts_clk_fixed_divider("sd1_cclk_shift_6_10", "sd1_cclk_div2", 1));
	clk_dm(TS_CLK_TX5215_SD1_CCLK_SHIFT_7_10, "sd1_cclk_shift_7_10",
		ts_clk_fixed_divider("sd1_cclk_shift_7_10", "sd1_cclk_div2", 1));
	clk_dm(TS_CLK_TX5215_SD1_CCLK_SHIFT_8_10, "sd1_cclk_shift_8_10",
		ts_clk_fixed_divider("sd1_cclk_shift_8_10", "sd1_cclk_div2", 1));
	clk_dm(TS_CLK_TX5215_SD1_CCLK_SHIFT_9_10, "sd1_cclk_shift_9_10",
		ts_clk_fixed_divider("sd1_cclk_shift_9_10", "sd1_cclk_div2", 1));
	...
	REGISTER_COMP(TS_CLK_TX5215_RNE_CCLK, "rne_cclk");
	REGISTER_COMP(TS_CLK_TX5215_CHIP_OCLK_I0, "chip_oclk0");
	REGISTER_COMP(TS_CLK_TX5215_CHIP_OCLK_I1, "chip_oclk1");
...
#define REGISTER_COMP_NOMUX(id, name, parent) \
	...
	REGISTER_COMP_NOMUX(TS_CLK_TX5215_AUD_DIV_ED_TMR_SRTB, "aud_ed_tmr_strb", "aud_dac_cclk");
	REGISTER_COMP_NOMUX(TS_CLK_TX5215_AUD_DAC_PBCLK_DIV, "aud_dac_pbclk", "aud_dac_cclk");
	REGISTER_COMP_NOMUX(TS_CLK_TX5215_DIV1_CODEC_DAC_CCLK, "aud_dac_cclk", "aud_dac_cclk_div0");
	REGISTER_COMP_NOMUX(TS_CLK_TX5215_DIV0_CODEC_DAC_CCLK, "aud_dac_cclk_div0", "pll1");
	REGISTER_COMP_NOMUX(TS_CLK_TX5215_DIV1_CODEC_ADC_CCLK, "aud_adc_cclk", "codec_adc_cclk_div0");
	REGISTER_COMP_NOMUX(TS_CLK_TX5215_DIV0_CODEC_ADC_CCLK, "codec_adc_cclk_div0", "pll1");
...
#define REGISTER_DIV(id, name, parent) do {\
		const struct ts_div_params *params = &ts_tx5215_divs[DIVIFY(id)]; \
		clk_dm(id, name, \
...
#define REGISTER_GATE(id, name, parent) do { \
		const struct ts_gate_params *params = &ts_tx5215_gates[GATEIFY(id)]; \
		clk_dm(id, name, \
	...
	REGISTER_GATE(TS_CLK_TX5215_CAN1_PCLK, "can1_pclk", "peri_apb_clk");
	REGISTER_GATE(TS_CLK_TX5215_CAN0_PCLK, "can0_pclk", "peri_apb_clk");
	...
	REGISTER_GATE(TS_CLK_TX5215_PTP_REF_CLK, "gmii_ptp_clk", &osc_in[0]);
	REGISTER_GATE(TS_CLK_TX5215_GMII_TX_CLK, "gmii_tx_clk", &osc_in[0]);
	REGISTER_GATE(TS_CLK_TX5215_MII_RX_CLK, "mii_rx_clk", &osc_in[0]);
...
static void clk_tx5215_init_clk_data(struct ts_clk_params *paras)
{
	struct clk_onecell_data *clk_data = &paras->clk_data;

	clk_data->clks = &tx_tx5215_clks[0];
	clk_data->clk_num = ARRAY_SIZE(tx_tx5215_clks);
}
...
int ts_clk_init_funcs(struct ts_clk_reg_funcs *pfuncs)
{
	...
	pfuncs->init_clk_data = clk_tx5215_init_clk_data;
	return 0;
}
